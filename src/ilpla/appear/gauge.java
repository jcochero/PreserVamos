...
public class gauge extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ilpla.appear.gauge");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ilpla.appear.gauge.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_AnimateValueTo(ilpla.appear.gauge parent,float _newvalue) {
this.parent = parent;
this._newvalue = _newvalue;
}
ilpla.appear.gauge parent;
float _newvalue;
long _n = 0L;
int _duration = 0;
float _start = 0f;
...
public ilpla.appear.gauge._gaugerange  _createrange(float _lowvalue,float _highvalue,int _color) throws Exception{
ilpla.appear.gauge._gaugerange _r = null;
...
_r = new ilpla.appear.gauge._gaugerange();
...
ilpla.appear.gauge._gaugerange _gr = null;
...
_gr = (ilpla.appear.gauge._gaugerange)(group9.Get(index9));
...
_r = (ilpla.appear.gauge._gaugerange)(group2.Get(index2));

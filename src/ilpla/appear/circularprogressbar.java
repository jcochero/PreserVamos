...
public class circularprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "ilpla.appear.circularprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", ilpla.appear.circularprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_AnimateValueTo(ilpla.appear.circularprogressbar parent,float _newvalue) {
this.parent = parent;
this._newvalue = _newvalue;
}
ilpla.appear.circularprogressbar parent;
float _newvalue;
long _n = 0L;
int _duration = 0;
float _start = 0f;

...
public class aprender_muestreo extends Activity implements B4AActivity{
	public static aprender_muestreo mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ilpla.appear", "ilpla.appear.aprender_muestreo");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (aprender_muestreo).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ilpla.appear", "ilpla.appear.aprender_muestreo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ilpla.appear.aprender_muestreo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
        ...
        BA.LogInfo("** Activity (aprender_muestreo) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return aprender_muestreo.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (aprender_muestreo) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (aprender_muestreo) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            aprender_muestreo mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"Aprender_Muestreo\")";
...
public static String  _btncerrar_click() throws Exception{
 //BA.debugLineNum = 33;BA.debugLine="Sub btnCerrar_Click";

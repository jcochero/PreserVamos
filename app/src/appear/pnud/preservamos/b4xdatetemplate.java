...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "appear.pnud.preservamos.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", appear.pnud.preservamos.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public appear.pnud.preservamos.b4xdialog _mdialog = null;
...
_mdialog = new appear.pnud.preservamos.b4xdialog();
...
public ResumableSub_Show(appear.pnud.preservamos.b4xdatetemplate parent,appear.pnud.preservamos.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
appear.pnud.preservamos.b4xdatetemplate parent;

...
anywheresoftware.b4a.objects.collections.Map _map1 = null;
 //BA.debugLineNum = 140;BA.debugLine="Sub btnOkTipo_Click";
 //BA.debugLineNum = 141;BA.debugLine="If lblRojo.Visible = False Then";
if (mostCurrent._lblrojo.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 142;BA.debugLine="ToastMessageShow(\"¡Debes elegir un tipo de ambie";
...
if (true) return "";
 ...
 //BA.debugLineNum = 146;BA.debugLine="Dim Map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 147;BA.debugLine="Map1.Initialize";
_map1.Initialize();
 //BA.debugLineNum = 148;BA.debugLine="Map1.Put(\"Id\", currentproject)";
_map1.Put((Object)("Id"),(Object)(_currentproject));
 //BA.debugLineNum = 149;BA.debugLine="If opcionElegida = \"llanura\" Or opcionElegida = \"";
if ((mostCurrent._opcionelegida).equals("llanura") || (mostCurrent._opcionelegida).equals("")) { 
 //BA.debugLineNum = 150;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"ti";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","tiporio",(Object)("llanura"),_map1);
 //BA.debugLineNum = 151;BA.debugLine="tipoAmbiente = \"llanura\"";
_tipoambiente = "llanura";
 }else if((mostCurrent._opcionelegida).equals("laguna")) { 
 //BA.debugLineNum = 153;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"ti";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","tiporio",(Object)("laguna"),_map1);
 //BA.debugLineNum = 154;BA.debugLine="tipoAmbiente = \"laguna\"";
_tipoambiente = "laguna";
 }else {
 };
 //BA.debugLineNum = 159;BA.debugLine="If txtNombreRio.Text <> \"\" Then";
...
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","nombresitio",(Object)(mostCurrent._txtnombrerio.getText()),_map1);
 ...
 //BA.debugLineNum = 162;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"no";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","nombresitio",(Object)("Sin nombre"),_map1);
 ...
 //BA.debugLineNum = 165;BA.debugLine="frmLocalizacion.currentproject = currentproject";
mostCurrent._frmlocalizacion._currentproject /*String*/  = _currentproject;
 //BA.debugLineNum = 166;BA.debugLine="frmLocalizacion.origen = \"Reporte_Localizacion\"";
mostCurrent._frmlocalizacion._origen /*String*/  = "Reporte_Localizacion";
 //BA.debugLineNum = 167;BA.debugLine="frmLocalizacion.tipoAmbiente = tipoAmbiente";
mostCurrent._frmlocalizacion._tipoambiente /*String*/  = _tipoambiente;
 //BA.debugLineNum = 168;BA.debugLine="frmLocalizacion.tipoDetect = \"GPSdetect\"";
...
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 173;BA.debugLine="StartActivity(frmLocalizacion)";
...
mostCurrent._lblrojo.setLeft(mostCurrent._imglaguna.getLeft());
 //BA.debugLineNum = 129;BA.debugLine="opcionElegida = \"laguna\"";
mostCurrent._opcionelegida = "laguna";
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public static String  _imgriollanura_click() throws Exception{
 //BA.debugLineNum = 132;BA.debugLine="Sub imgRioLlanura_Click";
 //BA.debugLineNum = 133;BA.debugLine="lblRojo.Visible = True";
mostCurrent._lblrojo.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 134;BA.debugLine="lblRojo.Left = imgRioLlanura.Left";
mostCurrent._lblrojo.setLeft(mostCurrent._imgriollanura.getLeft());
 //BA.debugLineNum = 135;BA.debugLine="opcionElegida = \"llanura\"";
...
anywheresoftware.b4a.keywords.Common.LogImpl("627656238",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);

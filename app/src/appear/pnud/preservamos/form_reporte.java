...
anywheresoftware.b4a.objects.collections.Map _map1 = null;
 //BA.debugLineNum = 150;BA.debugLine="Sub btnOkTipo_Click";
 //BA.debugLineNum = 151;BA.debugLine="If lblRojo.Visible = False Then";
if (mostCurrent._lblrojo.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 152;BA.debugLine="ToastMessageShow(\"¡Debes elegir un tipo de ambie";
...
if (true) return "";
 ...
 //BA.debugLineNum = 156;BA.debugLine="Dim Map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 157;BA.debugLine="Map1.Initialize";
_map1.Initialize();
 //BA.debugLineNum = 158;BA.debugLine="Map1.Put(\"Id\", currentproject)";
_map1.Put((Object)("Id"),(Object)(_currentproject));
 //BA.debugLineNum = 159;BA.debugLine="If opcionElegida = \"llanura\" Or opcionElegida = \"";
if ((mostCurrent._opcionelegida).equals("llanura") || (mostCurrent._opcionelegida).equals("")) { 
 //BA.debugLineNum = 160;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"ti";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","tiporio",(Object)("llanura"),_map1);
 //BA.debugLineNum = 161;BA.debugLine="tipoAmbiente = \"llanura\"";
_tipoambiente = "llanura";
 }else if((mostCurrent._opcionelegida).equals("laguna")) { 
 //BA.debugLineNum = 163;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"ti";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","tiporio",(Object)("laguna"),_map1);
 //BA.debugLineNum = 164;BA.debugLine="tipoAmbiente = \"laguna\"";
_tipoambiente = "laguna";
 }else {
 };
 //BA.debugLineNum = 169;BA.debugLine="If txtNombreRio.Text <> \"\" Then";
if ((mostCurrent._txtnombrerio.getText()).equals("") == false) { 
 //BA.debugLineNum = 170;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"no";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","nombresitio",(Object)(mostCurrent._txtnombrerio.getText()),_map1);
 ...
 //BA.debugLineNum = 172;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"no";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","nombresitio",(Object)("Sin nombre"),_map1);
 ...
 //BA.debugLineNum = 175;BA.debugLine="frmLocalizacion.currentproject = currentproject";
mostCurrent._frmlocalizacion._currentproject /*String*/  = _currentproject;
 //BA.debugLineNum = 176;BA.debugLine="frmLocalizacion.origen = \"Reporte_Localizacion\"";
mostCurrent._frmlocalizacion._origen /*String*/  = "Reporte_Localizacion";
 //BA.debugLineNum = 177;BA.debugLine="frmLocalizacion.tipoAmbiente = tipoAmbiente";
mostCurrent._frmlocalizacion._tipoambiente /*String*/  = _tipoambiente;
 //BA.debugLineNum = 178;BA.debugLine="frmLocalizacion.tipoDetect = \"GPSdetect\"";
...
public static String  _imglaguna_click() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub imgLaguna_Click";
 //BA.debugLineNum = 137;BA.debugLine="lblRojo.Visible = True";
mostCurrent._lblrojo.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 138;BA.debugLine="lblRojo.Left = imgLaguna.Left";
mostCurrent._lblrojo.setLeft(mostCurrent._imglaguna.getLeft());
 //BA.debugLineNum = 139;BA.debugLine="opcionElegida = \"laguna\"";
mostCurrent._opcionelegida = "laguna";
 //BA.debugLineNum = 140;BA.debugLine="End Sub";
return "";
}
public static String  _imgriollanura_click() throws Exception{
 //BA.debugLineNum = 142;BA.debugLine="Sub imgRioLlanura_Click";
 //BA.debugLineNum = 143;BA.debugLine="lblRojo.Visible = True";
mostCurrent._lblrojo.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 144;BA.debugLine="lblRojo.Left = imgRioLlanura.Left";
mostCurrent._lblrojo.setLeft(mostCurrent._imgriollanura.getLeft());
 //BA.debugLineNum = 145;BA.debugLine="opcionElegida = \"llanura\"";
...
_currentprojectmap = mostCurrent._dbutils._executemap /*anywheresoftware.b4a.objects.collections.Map*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"SELECT * FROM evals ORDER BY id DESC LIMIT 1",(String[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 92;BA.debugLine="Dim usernameNoAccent As String";
_usernamenoaccent = "";
 //BA.debugLineNum = 93;BA.debugLine="usernameNoAccent = Main.username.Replace(\"á\", \"a";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("á","a");
 //BA.debugLineNum = 94;BA.debugLine="usernameNoAccent = Main.username.Replace(\"é\", \"e";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("é","e");
 //BA.debugLineNum = 95;BA.debugLine="usernameNoAccent = Main.username.Replace(\"í\", \"i";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("í","i");
 //BA.debugLineNum = 96;BA.debugLine="usernameNoAccent = Main.username.Replace(\"ó\", \"o";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("ó","o");
 //BA.debugLineNum = 97;BA.debugLine="usernameNoAccent = Main.username.Replace(\"ú\", \"u";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("ú","u");
 //BA.debugLineNum = 98;BA.debugLine="usernameNoAccent = Main.username.Replace(\"ñ\", \"n";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("ñ","n");
 //BA.debugLineNum = 99;BA.debugLine="usernameNoAccent = Main.username.Replace(\"@\", \"a";
_usernamenoaccent = mostCurrent._main._username /*String*/ .replace("@","ae");
 //BA.debugLineNum = 101;BA.debugLine="If currentprojectMap = Null Or currentprojectMap";
if (_currentprojectmap== null || _currentprojectmap.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 102;BA.debugLine="currentproject = 1";
_currentproject = BA.NumberToString(1);
 //BA.debugLineNum = 103;BA.debugLine="Main.currentproject = currentproject";
mostCurrent._main._currentproject /*String*/  = _currentproject;
 //BA.debugLineNum = 104;BA.debugLine="Dim Map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 105;BA.debugLine="Map1.Initialize";
_map1.Initialize();
 //BA.debugLineNum = 106;BA.debugLine="Map1.Put(\"Id\", currentproject)";
_map1.Put((Object)("Id"),(Object)(_currentproject));
 //BA.debugLineNum = 107;BA.debugLine="DateTime.DateFormat = \"dd-MM-yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("dd-MM-yyyy");
 //BA.debugLineNum = 108;BA.debugLine="datecurrentproject = DateTime.Date(DateTime.Now";
_datecurrentproject = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 110;BA.debugLine="fullidcurrentproject = usernameNoAccent & \"_\" &";
_fullidcurrentproject = _usernamenoaccent+"_"+_currentproject+"_"+_datecurrentproject;
 //BA.debugLineNum = 111;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"f";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","fullID",(Object)(_fullidcurrentproject),_map1);
 //BA.debugLineNum = 112;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"t";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","terminado",(Object)("no"),_map1);
 //BA.debugLineNum = 113;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"e";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","evalsent",(Object)("no"),_map1);
 ...
 //BA.debugLineNum = 115;BA.debugLine="currentproject = currentprojectMap.Get(\"id\")";
_currentproject = BA.ObjectToString(_currentprojectmap.Get((Object)("id")));
 //BA.debugLineNum = 116;BA.debugLine="Main.currentproject = currentproject";
mostCurrent._main._currentproject /*String*/  = _currentproject;
 //BA.debugLineNum = 117;BA.debugLine="Dim Map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 118;BA.debugLine="Map1.Initialize";
_map1.Initialize();
 //BA.debugLineNum = 119;BA.debugLine="Map1.Put(\"Id\", currentproject)";
_map1.Put((Object)("Id"),(Object)(_currentproject));
 //BA.debugLineNum = 120;BA.debugLine="DateTime.DateFormat = \"dd-MM-yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("dd-MM-yyyy");
 //BA.debugLineNum = 121;BA.debugLine="datecurrentproject = DateTime.Date(DateTime.Now";
_datecurrentproject = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 122;BA.debugLine="fullidcurrentproject = usernameNoAccent & \"_\" &";
_fullidcurrentproject = _usernamenoaccent+"_"+_currentproject+"_"+_datecurrentproject;
 //BA.debugLineNum = 123;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"f";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","fullID",(Object)(_fullidcurrentproject),_map1);
 //BA.debugLineNum = 124;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"t";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","terminado",(Object)("no"),_map1);
 //BA.debugLineNum = 125;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"e";
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","evalsent",(Object)("no"),_map1);
 };
 } 
       catch (Exception e49) {
			processBA.setLastException(e49); //BA.debugLineNum = 128;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("535651640",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 //BA.debugLineNum = 129;BA.debugLine="ToastMessageShow(\"Hubo un error, intente de nuev";

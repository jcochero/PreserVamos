...
anywheresoftware.b4a.keywords.Common.LogImpl("627066369","Message arrived",0);
 //BA.debugLineNum = 29;BA.debugLine="Log($\"Message data: ${Message.GetData}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("627066370",("Message data: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_message.GetData().getObject()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("626935299",_fm.getToken(),0);

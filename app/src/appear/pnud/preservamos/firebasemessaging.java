...
anywheresoftware.b4a.keywords.Common.LogImpl("031326209","Message arrived",0);
 //BA.debugLineNum = 29;BA.debugLine="Log($\"Message data: ${Message.GetData}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("031326210",("Message data: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_message.GetData().getObject()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("031195139",_fm.getToken(),0);

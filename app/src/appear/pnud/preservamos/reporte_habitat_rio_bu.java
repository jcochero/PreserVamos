...
public class reporte_habitat_rio_bu extends Activity implements B4AActivity{
	public static reporte_habitat_rio_bu mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "appear.pnud.preservamos", "appear.pnud.preservamos.reporte_habitat_rio_bu");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (reporte_habitat_rio_bu).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "appear.pnud.preservamos", "appear.pnud.preservamos.reporte_habitat_rio_bu");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "appear.pnud.preservamos.reporte_habitat_rio_bu", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (reporte_habitat_rio_bu) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (reporte_habitat_rio_bu) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return reporte_habitat_rio_bu.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (reporte_habitat_rio_bu) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (reporte_habitat_rio_bu) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            reporte_habitat_rio_bu mc = mostCurrent;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 //BA.debugLineNum = 292;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 293;BA.debugLine="ProgressDialogShow2(\"Cargando cuestionario...\", F";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,BA.ObjectToCharSequence("Cargando cuestionario..."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 295;BA.debugLine="Activity.LoadLayout(\"Rio_Main_Large\")";
mostCurrent._activity.LoadLayout("Rio_Main_Large",mostCurrent.activityBA);
 //BA.debugLineNum = 300;BA.debugLine="preguntanumero = 1";
...
mostCurrent._tabreportehabitatrio.LoadLayout("reporte_habitat_rio_q9",BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 361;BA.debugLine="btnPrev.Visible = True";
mostCurrent._btnprev.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 364;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 365;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregunta";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 378;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 379;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 380;BA.debugLine="If currentscreen = \"foto\" Then";
if ((mostCurrent._currentscreen).equals("foto")) { 
 //BA.debugLineNum = 381;BA.debugLine="fondogris.RemoveView";
mostCurrent._fondogris.RemoveView();
 //BA.debugLineNum = 382;BA.debugLine="If mag1.IsInitialized Then";
if (mostCurrent._mag1.IsInitialized()) { 
 //BA.debugLineNum = 383;BA.debugLine="mag1.RemoveView";
mostCurrent._mag1.RemoveView();
 };
 //BA.debugLineNum = 385;BA.debugLine="currentscreen = \"\"";
mostCurrent._currentscreen = "";
 }else {
 //BA.debugLineNum = 387;BA.debugLine="If tabReporteHabitatRio.CurrentPage = 0 Then";
if (mostCurrent._tabreportehabitatrio.getCurrentPage()==0) { 
 //BA.debugLineNum = 388;BA.debugLine="If pnlQuestions.Visible = False Then";
if (mostCurrent._pnlquestions.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 389;BA.debugLine="closeScrMsgBox";
_closescrmsgbox();
 }else {
 //BA.debugLineNum = 392;BA.debugLine="btnPrev_Click";
_btnprev_click();
 };
 }else {
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 401;BA.debugLine="Return False";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 //BA.debugLineNum = 374;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 376;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 369;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 372;BA.debugLine="End Sub";
return "";
}
public static String  _btncerrar_click() throws Exception{
 //BA.debugLineNum = 1742;BA.debugLine="Sub btnCerrar_Click";
 //BA.debugLineNum = 1743;BA.debugLine="pnlResultados.Visible = False";
mostCurrent._pnlresultados.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1747;BA.debugLine="Activity.RemoveAllViews";
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 1748;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 1749;BA.debugLine="StartActivity(Reporte_Fotos)";
...
int _countveg = 0;
 //BA.debugLineNum = 663;BA.debugLine="Private Sub btnNext_Click";
 //BA.debugLineNum = 664;BA.debugLine="btnTerminar.Visible = False";
mostCurrent._btnterminar.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 667;BA.debugLine="If tabReporteHabitatRio.CurrentPage = 0 Then 'q1";
if (mostCurrent._tabreportehabitatrio.getCurrentPage()==0) { 
 //BA.debugLineNum = 668;BA.debugLine="If lblRojo_Q1.Visible = False Then";
if (mostCurrent._lblrojo_q1.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 669;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
...
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta2,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 693;BA.debugLine="If valorind5 = \"\" Then";
if ((mostCurrent._valorind5).equals("")) { 
 //BA.debugLineNum = 694;BA.debugLine="If lblRojo_Q2.Visible = False Then";
if (mostCurrent._lblrojo_q2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 695;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 698;BA.debugLine="tabReporteHabitatRio.ScrollTo(3, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (3),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 699;BA.debugLine="currentpregunta = 3";
_currentpregunta = (int) (3);
 };
 }else {
 //BA.debugLineNum = 703;BA.debugLine="If lblRojo_Q2.Visible = False Then";
if (mostCurrent._lblrojo_q2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 704;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 707;BA.debugLine="tabReporteHabitatRio.ScrollTo(4, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (4),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 708;BA.debugLine="currentpregunta = 4";
_currentpregunta = (int) (4);
 //BA.debugLineNum = 710;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 711;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 713;BA.debugLine="btnPregunta2.Visible = False";
mostCurrent._btnpregunta2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 714;BA.debugLine="btnPregunta3.Visible = True";
mostCurrent._btnpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 715;BA.debugLine="lblPregunta2.Visible = False";
mostCurrent._lblpregunta2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 716;BA.debugLine="lblPregunta3.Visible = True";
mostCurrent._lblpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 717;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregu";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta3,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 722;BA.debugLine="If lblRojo_Q2p2.Visible = False Then";
if (mostCurrent._lblrojo_q2p2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 723;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 726;BA.debugLine="tabReporteHabitatRio.ScrollTo(4, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (4),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 727;BA.debugLine="currentpregunta = 4";
_currentpregunta = (int) (4);
 //BA.debugLineNum = 729;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 730;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 732;BA.debugLine="btnPregunta2.Visible = False";
mostCurrent._btnpregunta2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 733;BA.debugLine="btnPregunta3.Visible = True";
mostCurrent._btnpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 734;BA.debugLine="lblPregunta2.Visible = False";
mostCurrent._lblpregunta2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 735;BA.debugLine="lblPregunta3.Visible = True";
mostCurrent._lblpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 736;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta3,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==4) { 
 //BA.debugLineNum = 741;BA.debugLine="If lblRojo_Q2p3.Visible = False Then";
if (mostCurrent._lblrojo_q2p3.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 742;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 745;BA.debugLine="tabReporteHabitatRio.ScrollTo(5, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (5),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 746;BA.debugLine="currentpregunta =5";
_currentpregunta = (int) (5);
 //BA.debugLineNum = 748;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 749;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 751;BA.debugLine="btnPregunta3.Visible = False";
mostCurrent._btnpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 752;BA.debugLine="btnPregunta4.Visible = True";
mostCurrent._btnpregunta4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 753;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta4,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 //BA.debugLineNum = 754;BA.debugLine="lblPregunta3.Visible = False";
mostCurrent._lblpregunta3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 755;BA.debugLine="lblPregunta4.Visible = True";
mostCurrent._lblpregunta4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 760;BA.debugLine="If lblRojo_Q2p4.Visible = False Then";
if (mostCurrent._lblrojo_q2p4.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 761;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 764;BA.debugLine="tabReporteHabitatRio.ScrollTo(6, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (6),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 765;BA.debugLine="currentpregunta =6";
_currentpregunta = (int) (6);
 //BA.debugLineNum = 767;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 768;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 770;BA.debugLine="btnPregunta4.Visible = False";
mostCurrent._btnpregunta4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 771;BA.debugLine="btnPregunta5.Visible = True";
mostCurrent._btnpregunta5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 773;BA.debugLine="lblPregunta4.Visible = False";
mostCurrent._lblpregunta4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 774;BA.debugLine="lblPregunta5.Visible = True";
mostCurrent._lblpregunta5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 775;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta5,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 779;BA.debugLine="If lblRojo_Q3.Visible = False Then";
if (mostCurrent._lblrojo_q3.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 780;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 783;BA.debugLine="tabReporteHabitatRio.ScrollTo(7, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (7),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 784;BA.debugLine="currentpregunta =7";
_currentpregunta = (int) (7);
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==7) { 
 //BA.debugLineNum = 787;BA.debugLine="If valorind7 <> \"10\" Then 'si hay basura o en ag";
if ((mostCurrent._valorind7).equals("10") == false) { 
 //BA.debugLineNum = 788;BA.debugLine="If lblRojo_Q3p2.Visible = False Then";
if (mostCurrent._lblrojo_q3p2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 789;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 792;BA.debugLine="tabReporteHabitatRio.ScrollTo(8, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (8),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 793;BA.debugLine="currentpregunta =8";
_currentpregunta = (int) (8);
 };
 }else {
 //BA.debugLineNum = 798;BA.debugLine="tabReporteHabitatRio.ScrollTo(9, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (9),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 799;BA.debugLine="currentpregunta =9";
...
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta6,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 813;BA.debugLine="If lblRojo_Q3p3_a.visible = True And valorind7 >";
...
mostCurrent._valorind7 = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind7))-1);
 ...
 //BA.debugLineNum = 816;BA.debugLine="If lblRojo_Q3p3_b.visible = True  And valorind7";
...
mostCurrent._valorind7 = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind7))-1);
 ...
 //BA.debugLineNum = 819;BA.debugLine="If lblRojo_Q3p3_c.visible = True  And valorind7";
if (mostCurrent._lblrojo_q3p3_c.getVisible()==anywheresoftware.b4a.keywords.Common.True && (double)(Double.parseDouble(mostCurrent._valorind7))>0) { 
 //BA.debugLineNum = 820;BA.debugLine="valorind7 = valorind7 -1";
mostCurrent._valorind7 = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind7))-1);
 };
 //BA.debugLineNum = 822;BA.debugLine="If lblRojo_Q3p3_d.visible = True  And valorind7";
if (mostCurrent._lblrojo_q3p3_d.getVisible()==anywheresoftware.b4a.keywords.Common.True && (double)(Double.parseDouble(mostCurrent._valorind7))>0) { 
 //BA.debugLineNum = 823;BA.debugLine="valorind7 = valorind7 -1";
mostCurrent._valorind7 = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind7))-1);
 };
 //BA.debugLineNum = 825;BA.debugLine="If valorind7 <= 2 Then";
if ((double)(Double.parseDouble(mostCurrent._valorind7))<=2) { 
 //BA.debugLineNum = 826;BA.debugLine="valorind7 = 0";
...
mostCurrent._lblpregunta6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 840;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregunt";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta6,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==9) { 
 //BA.debugLineNum = 842;BA.debugLine="If lblRojo_Q4_2.Visible = False Then";
if (mostCurrent._lblrojo_q4_2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 843;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 846;BA.debugLine="tabReporteHabitatRio.ScrollTo(10, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (10),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 847;BA.debugLine="currentpregunta =10";
_currentpregunta = (int) (10);
 //BA.debugLineNum = 849;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 850;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 852;BA.debugLine="btnPregunta6.Visible = False";
mostCurrent._btnpregunta6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 853;BA.debugLine="btnPregunta7.Visible = True";
mostCurrent._btnpregunta7.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 855;BA.debugLine="lblPregunta6.Visible = False";
mostCurrent._lblpregunta6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 856;BA.debugLine="lblPregunta7.Visible = True";
mostCurrent._lblpregunta7.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 857;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta7,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 860;BA.debugLine="If lblRojo_Q4p2.Visible = False Then";
if (mostCurrent._lblrojo_q4p2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 861;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 864;BA.debugLine="tabReporteHabitatRio.ScrollTo(11, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (11),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 865;BA.debugLine="currentpregunta =11";
_currentpregunta = (int) (11);
 //BA.debugLineNum = 866;BA.debugLine="scrollUsos.Panel.LoadLayout(\"pnlQ5_usos\")";
mostCurrent._scrollusos.getPanel().LoadLayout("pnlQ5_usos",mostCurrent.activityBA);
 //BA.debugLineNum = 867;BA.debugLine="scrollUsos.Panel.Height = imgQ5_1_i.Height + im";
...
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta8,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 882;BA.debugLine="If haycampo = True Then";
if (_haycampo==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 884;BA.debugLine="tabReporteHabitatRio.ScrollTo(12, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (12),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 885;BA.debugLine="currentpregunta =12";
_currentpregunta = (int) (12);
 }else {
 //BA.debugLineNum = 887;BA.debugLine="If lblRojo_Q5_1.Visible = False Then";
if (mostCurrent._lblrojo_q5_1.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 888;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 891;BA.debugLine="tabReporteHabitatRio.ScrollTo(14, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (14),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 892;BA.debugLine="scrollVegetacion.Panel.LoadLayout(\"pnlQ6_veget";
mostCurrent._scrollvegetacion.getPanel().LoadLayout("pnlQ6_vegetacion",mostCurrent.activityBA);
 //BA.debugLineNum = 893;BA.debugLine="scrollVegetacion.Panel.Height = imgQ6_e.Height";
mostCurrent._scrollvegetacion.getPanel().setHeight((int) (mostCurrent._imgq6_e.getHeight()+mostCurrent._imgq6_e.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 894;BA.debugLine="currentpregunta =14";
_currentpregunta = (int) (14);
 //BA.debugLineNum = 896;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 897;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 899;BA.debugLine="btnPregunta8.Visible = False";
mostCurrent._btnpregunta8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 900;BA.debugLine="btnPregunta9.Visible = True";
mostCurrent._btnpregunta9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 902;BA.debugLine="lblPregunta8.Visible = False";
mostCurrent._lblpregunta8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 903;BA.debugLine="lblPregunta9.Visible = True";
mostCurrent._lblpregunta9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 904;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregu";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta9,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 910;BA.debugLine="If lblRojo_Q5p2.Visible = False Then";
if (mostCurrent._lblrojo_q5p2.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 911;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 914;BA.debugLine="tabReporteHabitatRio.ScrollTo(13, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (13),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 915;BA.debugLine="currentpregunta =13";
_currentpregunta = (int) (13);
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==13) { 
 //BA.debugLineNum = 918;BA.debugLine="If lblRojo_Q5p3.Visible = False Then";
if (mostCurrent._lblrojo_q5p3.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 919;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 922;BA.debugLine="tabReporteHabitatRio.ScrollTo(14, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (14),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 923;BA.debugLine="scrollVegetacion.Panel.LoadLayout(\"pnlQ6_vegeta";
mostCurrent._scrollvegetacion.getPanel().LoadLayout("pnlQ6_vegetacion",mostCurrent.activityBA);
...
mostCurrent._lblpregunta9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 935;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta9,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==14) { 
 //BA.debugLineNum = 940;BA.debugLine="Dim countveg As Int";
_countveg = 0;
 //BA.debugLineNum = 941;BA.debugLine="If lblRojo_Q6_a.visible = True Then";
...
_countveg = (int) (_countveg+1);
 ...
 //BA.debugLineNum = 944;BA.debugLine="If lblRojo_Q6_b.visible = True Then";
...
_countveg = (int) (_countveg+1);
 ...
 //BA.debugLineNum = 947;BA.debugLine="If lblRojo_Q6_c.visible = True Then";
if (mostCurrent._lblrojo_q6_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 948;BA.debugLine="countveg = countveg + 1";
_countveg = (int) (_countveg+1);
 };
 //BA.debugLineNum = 950;BA.debugLine="If lblRojo_Q6_d.visible = True Then";
if (mostCurrent._lblrojo_q6_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 951;BA.debugLine="countveg = countveg + 1";
_countveg = (int) (_countveg+1);
 };
 //BA.debugLineNum = 953;BA.debugLine="If lblRojo_Q6_e.visible = True Then";
if (mostCurrent._lblrojo_q6_e.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 954;BA.debugLine="countveg = 0";
_countveg = (int) (0);
 };
 //BA.debugLineNum = 956;BA.debugLine="If countveg >= 3 Then";
if (_countveg>=3) { 
 //BA.debugLineNum = 957;BA.debugLine="valorind3 = 10";
mostCurrent._valorind3 = BA.NumberToString(10);
 }else if(_countveg==2) { 
 //BA.debugLineNum = 959;BA.debugLine="valorind3 = 8";
mostCurrent._valorind3 = BA.NumberToString(8);
 }else if(_countveg==1) { 
 //BA.debugLineNum = 961;BA.debugLine="valorind3 = 4";
mostCurrent._valorind3 = BA.NumberToString(4);
 }else if(_countveg==0) { 
 //BA.debugLineNum = 963;BA.debugLine="valorind3 = 0";
mostCurrent._valorind3 = BA.NumberToString(0);
 };
 //BA.debugLineNum = 965;BA.debugLine="If lblRojo_Q6_a.Visible = False And lblRojo_Q6_b";
if (mostCurrent._lblrojo_q6_a.getVisible()==anywheresoftware.b4a.keywords.Common.False && mostCurrent._lblrojo_q6_b.getVisible()==anywheresoftware.b4a.keywords.Common.False && mostCurrent._lblrojo_q6_c.getVisible()==anywheresoftware.b4a.keywords.Common.False && mostCurrent._lblrojo_q6_d.getVisible()==anywheresoftware.b4a.keywords.Common.False && mostCurrent._lblrojo_q6_e.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 967;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 970;BA.debugLine="tabReporteHabitatRio.ScrollTo(15, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (15),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 971;BA.debugLine="scrollExoticas1.Panel.LoadLayout(\"pnlExoticas_A";
mostCurrent._scrollexoticas1.getPanel().LoadLayout("pnlExoticas_Acacia",mostCurrent.activityBA);
 //BA.debugLineNum = 972;BA.debugLine="scrollExoticas1.Panel.Height = imgQ6_1_c.Height";
mostCurrent._scrollexoticas1.getPanel().setHeight((int) (mostCurrent._imgq6_1_c.getHeight()+mostCurrent._imgq6_1_c.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 973;BA.debugLine="currentpregunta =15";
_currentpregunta = (int) (15);
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==15) { 
 //BA.debugLineNum = 978;BA.debugLine="If lblRojo_Q6_1.Visible = False Then";
if (mostCurrent._lblrojo_q6_1.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 979;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 982;BA.debugLine="tabReporteHabitatRio.ScrollTo(16, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (16),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 983;BA.debugLine="scrollExoticas2.Panel.LoadLayout(\"pnlExoticas_L";
mostCurrent._scrollexoticas2.getPanel().LoadLayout("pnlExoticas_Ligustro",mostCurrent.activityBA);
 //BA.debugLineNum = 984;BA.debugLine="scrollExoticas2.Panel.Height = imgQ6_3_c.Height";
mostCurrent._scrollexoticas2.getPanel().setHeight((int) (mostCurrent._imgq6_3_c.getHeight()+mostCurrent._imgq6_3_c.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 985;BA.debugLine="currentpregunta =16";
_currentpregunta = (int) (16);
 };
 }else if(mostCurrent._tabreportehabitatrio.getCurrentPage()==16) { 
 //BA.debugLineNum = 988;BA.debugLine="If lblRojo_Q6_3.Visible = False Then";
if (mostCurrent._lblrojo_q6_3.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 989;BA.debugLine="ToastMessageShow(\"Debe seleccionar una opción p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Debe seleccionar una opción para seguir"),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 992;BA.debugLine="tabReporteHabitatRio.ScrollTo(17, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (17),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 993;BA.debugLine="scrollAnimales.Panel.LoadLayout(\"pnlAnimales\")";
mostCurrent._scrollanimales.getPanel().LoadLayout("pnlAnimales",mostCurrent.activityBA);
 //BA.debugLineNum = 994;BA.debugLine="scrollAnimales.Panel.Height = imgQ4_e.Height +";
mostCurrent._scrollanimales.getPanel().setHeight((int) (mostCurrent._imgq4_e.getHeight()+mostCurrent._imgq4_e.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50))));
 //BA.debugLineNum = 995;BA.debugLine="currentpregunta =17";
_currentpregunta = (int) (17);
 //BA.debugLineNum = 997;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 998;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1000;BA.debugLine="btnPregunta9.Visible = False";
mostCurrent._btnpregunta9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1001;BA.debugLine="btnPregunta10.Visible = True";
mostCurrent._btnpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1003;BA.debugLine="lblPregunta9.Visible = False";
mostCurrent._lblpregunta9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1004;BA.debugLine="lblPregunta10.Visible = True";
mostCurrent._lblpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1005;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregun";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta10,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 1010;BA.debugLine="checklist = \"\"";
mostCurrent._checklist = "";
 //BA.debugLineNum = 1011;BA.debugLine="If lblRojo_Q4_a.visible  = True Then";
if (mostCurrent._lblrojo_q4_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1012;BA.debugLine="checklist = checklist & \";aves\"";
mostCurrent._checklist = mostCurrent._checklist+";aves";
 };
 //BA.debugLineNum = 1014;BA.debugLine="If lblRojo_Q4_b.visible  = True Then";
if (mostCurrent._lblrojo_q4_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1015;BA.debugLine="checklist = checklist & \";peces\"";
mostCurrent._checklist = mostCurrent._checklist+";peces";
 };
 //BA.debugLineNum = 1017;BA.debugLine="If lblRojo_Q4_c.visible  = True Then";
if (mostCurrent._lblrojo_q4_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1018;BA.debugLine="checklist = checklist & \";libelulas\"";
mostCurrent._checklist = mostCurrent._checklist+";libelulas";
 };
 //BA.debugLineNum = 1020;BA.debugLine="If lblRojo_Q4_d.visible  = True Then";
if (mostCurrent._lblrojo_q4_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1021;BA.debugLine="checklist = checklist & \";mosquitos\"";
mostCurrent._checklist = mostCurrent._checklist+";mosquitos";
 };
 //BA.debugLineNum = 1023;BA.debugLine="If lblRojo_Q4_e.visible  = True Then";
if (mostCurrent._lblrojo_q4_e.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1024;BA.debugLine="checklist = checklist & \";roedores\"";
mostCurrent._checklist = mostCurrent._checklist+";roedores";
 };
 //BA.debugLineNum = 1026;BA.debugLine="If lblRojo_Q4_f.visible  = True Then";
if (mostCurrent._lblrojo_q4_f.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1027;BA.debugLine="checklist = checklist & \";tortugas\"";
mostCurrent._checklist = mostCurrent._checklist+";tortugas";
 };
 //BA.debugLineNum = 1030;BA.debugLine="tabReporteHabitatRio.ScrollTo(18, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (18),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1031;BA.debugLine="currentpregunta =18";
_currentpregunta = (int) (18);
 //BA.debugLineNum = 1033;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1034;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1036;BA.debugLine="btnPregunta10.Visible = False";
mostCurrent._btnpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1037;BA.debugLine="btnPregunta11.Visible = True";
mostCurrent._btnpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1039;BA.debugLine="lblPregunta10.Visible = False";
mostCurrent._lblpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1040;BA.debugLine="lblPregunta11.Visible = True";
mostCurrent._lblpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1041;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregunt";
...
if (mostCurrent._lblrojo_q4_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1045;BA.debugLine="ind_pvm_5 = \"si\"";
mostCurrent._ind_pvm_5 = "si";
 }else {
 //BA.debugLineNum = 1047;BA.debugLine="ind_pvm_5 = \"no\"";
mostCurrent._ind_pvm_5 = "no";
 };
 //BA.debugLineNum = 1050;BA.debugLine="If lblRojo_Q4_c.visible = True Then";
if (mostCurrent._lblrojo_q4_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1051;BA.debugLine="ind_pvm_6 = \"si\"";
mostCurrent._ind_pvm_6 = "si";
 }else {
 //BA.debugLineNum = 1053;BA.debugLine="ind_pvm_6 = \"no\"";
mostCurrent._ind_pvm_6 = "no";
 };
 //BA.debugLineNum = 1056;BA.debugLine="If lblRojo_Q4_b.visible = True Then";
if (mostCurrent._lblrojo_q4_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1057;BA.debugLine="ind_pvm_7 = \"si\"";
mostCurrent._ind_pvm_7 = "si";
 }else {
 //BA.debugLineNum = 1059;BA.debugLine="ind_pvm_7 = \"no\"";
mostCurrent._ind_pvm_7 = "no";
 };
 //BA.debugLineNum = 1062;BA.debugLine="If lblRojo_Q4_d.visible = True Then";
if (mostCurrent._lblrojo_q4_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1063;BA.debugLine="ind_pvm_8 = \"si\"";
mostCurrent._ind_pvm_8 = "si";
 }else {
 //BA.debugLineNum = 1065;BA.debugLine="ind_pvm_8 = \"no\"";
mostCurrent._ind_pvm_8 = "no";
 };
 //BA.debugLineNum = 1068;BA.debugLine="tabReporteHabitatRio.ScrollTo(19, True)";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (19),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1069;BA.debugLine="currentpregunta =19";
_currentpregunta = (int) (19);
 //BA.debugLineNum = 1071;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1072;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1074;BA.debugLine="btnPregunta11.Visible = False";
mostCurrent._btnpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1075;BA.debugLine="lblPregunta11.Visible = False";
mostCurrent._lblpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1076;BA.debugLine="btnPregunta13.Visible = True";
mostCurrent._btnpregunta13.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1078;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnPregunt";
mostCurrent._utilidades._createhaloeffect /*void*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())),mostCurrent._btnpregunta13,anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (93),(int) (221),(int) (140)));
 ...
 //BA.debugLineNum = 1081;BA.debugLine="notas = txtNotas.text";
mostCurrent._notas = mostCurrent._txtnotas.getText();
 //BA.debugLineNum = 1084;BA.debugLine="btnPregunta13.Visible = False";
mostCurrent._btnpregunta13.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1086;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1087;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1088;BA.debugLine="btnTerminar.Visible = True";
mostCurrent._btnterminar.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1089;BA.debugLine="btnTerminar.Enabled =True";
mostCurrent._btnterminar.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1090;BA.debugLine="utilidades.CreateHaloEffect(Activity, btnTermina";
...
public static String  _btnpregunta1_click() throws Exception{
 //BA.debugLineNum = 1812;BA.debugLine="Sub btnPregunta1_Click";
...
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1815;BA.debugLine="btnPregunta1.Visible = False";
mostCurrent._btnpregunta1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1816;BA.debugLine="lblPregunta1.Visible = False";
mostCurrent._lblpregunta1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1817;BA.debugLine="End Sub";
return "";
}
public static String  _btnpregunta10_click() throws Exception{
 //BA.debugLineNum = 1866;BA.debugLine="Sub btnPregunta10_Click";
 //BA.debugLineNum = 1867;BA.debugLine="pnlQuestions.Visible = True";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1868;BA.debugLine="pnlImagen.Visible = False";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1869;BA.debugLine="btnPregunta10.Visible = False";
mostCurrent._btnpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1870;BA.debugLine="lblPregunta10.Visible = False";
mostCurrent._lblpregunta10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1871;BA.debugLine="End Sub";
return "";
}
public static String  _btnpregunta11_click() throws Exception{
 //BA.debugLineNum = 1872;BA.debugLine="Sub btnPregunta11_Click";
 //BA.debugLineNum = 1873;BA.debugLine="pnlQuestions.Visible = True";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1874;BA.debugLine="pnlImagen.Visible = False";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1875;BA.debugLine="btnPregunta11.Visible = False";
mostCurrent._btnpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1876;BA.debugLine="lblPregunta11.Visible = False";
mostCurrent._lblpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1877;BA.debugLine="End Sub";
return "";
}
public static String  _btnpregunta12_click() throws Exception{
 //BA.debugLineNum = 1878;BA.debugLine="Sub btnPregunta12_Click";
 //BA.debugLineNum = 1879;BA.debugLine="pnlQuestions.Visible = True";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1880;BA.debugLine="pnlImagen.Visible = False";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1881;BA.debugLine="btnPregunta12.Visible = False";
mostCurrent._btnpregunta12.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1882;BA.debugLine="lblPregunta12.Visible = False";
...
mostCurrent._tabreportehabitatrio.ScrollTo((int) (mostCurrent._tabreportehabitatrio.getCurrentPage()-1),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 437;BA.debugLine="currentpregunta = 1";
_currentpregunta = (int) (1);
 }else {
...
mostCurrent._tabreportehabitatrio.ScrollTo((int) (mostCurrent._tabreportehabitatrio.getCurrentPage()-1),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 444;BA.debugLine="currentpregunta = 2";
_currentpregunta = (int) (2);
 };
...
_currentpregunta = (int) (17);
 ...
 //BA.debugLineNum = 602;BA.debugLine="If pnlQuestions.Visible = False Then";
if (mostCurrent._pnlquestions.getVisible()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 603;BA.debugLine="btnPregunta11.Visible = False";
mostCurrent._btnpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 604;BA.debugLine="lblPregunta11.Visible = False";
mostCurrent._lblpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 605;BA.debugLine="pnlQuestions.Visible = True";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 606;BA.debugLine="pnlImagen.Visible = False";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 607;BA.debugLine="currentpregunta = 17";
_currentpregunta = (int) (17);
 //BA.debugLineNum = 608;BA.debugLine="tabReporteHabitatRio.ScrollTo(tabReporteHabitat";
mostCurrent._tabreportehabitatrio.ScrollTo((int) (mostCurrent._tabreportehabitatrio.getCurrentPage()-1),anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 611;BA.debugLine="pnlQuestions.Visible = False";
mostCurrent._pnlquestions.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 612;BA.debugLine="pnlImagen.Visible = True";
mostCurrent._pnlimagen.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 613;BA.debugLine="btnPregunta11.Visible = True";
mostCurrent._btnpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 614;BA.debugLine="lblPregunta11.Visible = True";
mostCurrent._lblpregunta11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 615;BA.debugLine="currentpregunta = 18";
_currentpregunta = (int) (18);
 };
 }else if(_currentpregunta==19) { 
 //BA.debugLineNum = 618;BA.debugLine="If pnlResultados.Visible = False Then";
...
public static String  _btnterminar_click() throws Exception{
 //BA.debugLineNum = 1139;BA.debugLine="Sub btnTerminar_Click";
 //BA.debugLineNum = 1140;BA.debugLine="btnTerminar.Enabled =False";
mostCurrent._btnterminar.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1141;BA.debugLine="TerminarEval";
_terminareval();
 //BA.debugLineNum = 1142;BA.debugLine="GuardarEval";
_guardareval();
...
_orden = (int) (_orden+1);
 ...
 //BA.debugLineNum = 1656;BA.debugLine="If valorind2 = 0 Then";
if ((mostCurrent._valorind2).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 1657;BA.debugLine="lbl_valorind2.Text = \"El ganado impacta fuerteme";
_lbl_valorind2.setText(BA.ObjectToCharSequence("El ganado impacta fuertemente en los arroyos, por pisoteo y aportando nutrientes"));
 //BA.debugLineNum = 1658;BA.debugLine="img_valorind2.Bitmap = LoadBitmapSample(File.Dir";
_img_valorind2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMM.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1659;BA.debugLine="scrResultados.Panel.AddView(img_valorind2, 10dip";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_valorind2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1660;BA.debugLine="scrResultados.Panel.AddView(lbl_valorind2, 50dip";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_valorind2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 1661;BA.debugLine="scrResultados.Panel.Height = orden * 90dip";
mostCurrent._scrresultados.getPanel().setHeight((int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90))));
 //BA.debugLineNum = 1662;BA.debugLine="orden = orden +1";
_orden = (int) (_orden+1);
 }else if((mostCurrent._valorind2).equals(BA.NumberToString(10))) { 
 //BA.debugLineNum = 1664;BA.debugLine="lbl_valorind2.Text = \"No hay ganado intensivo\"";
_lbl_valorind2.setText(BA.ObjectToCharSequence("No hay ganado intensivo"));
 //BA.debugLineNum = 1665;BA.debugLine="img_valorind2.Bitmap = LoadBitmapSample(File.Dir";
_img_valorind2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMB.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1666;BA.debugLine="scrResultados.Panel.AddView(img_valorind2, 10dip";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_valorind2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1667;BA.debugLine="scrResultados.Panel.AddView(lbl_valorind2, 50dip";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_valorind2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 1668;BA.debugLine="scrResultados.Panel.Height = orden * 90dip";
mostCurrent._scrresultados.getPanel().setHeight((int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90))));
 //BA.debugLineNum = 1669;BA.debugLine="orden = orden +1";
_orden = (int) (_orden+1);
 };
 //BA.debugLineNum = 1673;BA.debugLine="If valorind3 <> \"NS\" And valorind3 <> \"\" Then";
if ((mostCurrent._valorind3).equals("NS") == false && (mostCurrent._valorind3).equals("") == false) { 
 //BA.debugLineNum = 1674;BA.debugLine="If valorind3 >= 0 And valorind3 <= 5  Then";
if ((double)(Double.parseDouble(mostCurrent._valorind3))>=0 && (double)(Double.parseDouble(mostCurrent._valorind3))<=5) { 
 //BA.debugLineNum = 1675;BA.debugLine="lbl_valorind3.Text = \"Hay una pobre vegetación";
_lbl_valorind3.setText(BA.ObjectToCharSequence("Hay una pobre vegetación de ribera"));
 //BA.debugLineNum = 1676;BA.debugLine="img_valorind3.Bitmap = LoadBitmapSample(File.Di";
_img_valorind3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMM.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1677;BA.debugLine="scrResultados.Panel.AddView(img_valorind3, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_valorind3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1678;BA.debugLine="scrResultados.Panel.AddView(lbl_valorind3, 50di";
...
_orden = (int) (_orden+1);
 ...
 //BA.debugLineNum = 1682;BA.debugLine="lbl_valorind3.Text = \"Hay una moderada vegetaci";
_lbl_valorind3.setText(BA.ObjectToCharSequence("Hay una moderada vegetación de ribera"));
 //BA.debugLineNum = 1683;BA.debugLine="img_valorind3.Bitmap = LoadBitmapSample(File.Di";
_img_valorind3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaR.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1684;BA.debugLine="scrResultados.Panel.AddView(img_valorind3, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_valorind3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1685;BA.debugLine="scrResultados.Panel.AddView(lbl_valorind3, 50di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_valorind3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
...
_orden = (int) (_orden+1);
 ...
 //BA.debugLineNum = 1689;BA.debugLine="lbl_valorind3.Text = \"Hay una buen desarrollo d";
...
_orden = (int) (_orden+1);
 ...
 //BA.debugLineNum = 1699;BA.debugLine="If ind_pvm_3 <> \"NS\" And ind_pvm_3 <> \"\" Then";
if ((mostCurrent._ind_pvm_3).equals("NS") == false && (mostCurrent._ind_pvm_3).equals("") == false) { 
 //BA.debugLineNum = 1700;BA.debugLine="If ind_pvm_3 < 10 Then";
if ((double)(Double.parseDouble(mostCurrent._ind_pvm_3))<10) { 
 //BA.debugLineNum = 1701;BA.debugLine="lbl_ind_pvm_3.Text = \"La acacia negra es una es";
_lbl_ind_pvm_3.setText(BA.ObjectToCharSequence("La acacia negra es una especie altamente invasora!"));
 //BA.debugLineNum = 1702;BA.debugLine="img_ind_pvm_3.Bitmap = LoadBitmapSample(File.Di";
_img_ind_pvm_3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMM.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1703;BA.debugLine="scrResultados.Panel.AddView(img_ind_pvm_3, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_ind_pvm_3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1704;BA.debugLine="scrResultados.Panel.AddView(lbl_ind_pvm_3, 50di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_ind_pvm_3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 1705;BA.debugLine="scrResultados.Panel.Height = orden * 90dip";
mostCurrent._scrresultados.getPanel().setHeight((int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90))));
 //BA.debugLineNum = 1706;BA.debugLine="orden = orden +1";
_orden = (int) (_orden+1);
 }else {
 //BA.debugLineNum = 1708;BA.debugLine="lbl_ind_pvm_3.Text = \"No hay acacia negra, una";
_lbl_ind_pvm_3.setText(BA.ObjectToCharSequence("No hay acacia negra, una especie altamente invasora"));
 //BA.debugLineNum = 1709;BA.debugLine="img_ind_pvm_3.Bitmap = LoadBitmapSample(File.Di";
_img_ind_pvm_3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMB.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1710;BA.debugLine="scrResultados.Panel.AddView(img_ind_pvm_3, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_ind_pvm_3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1711;BA.debugLine="scrResultados.Panel.AddView(lbl_ind_pvm_3, 50di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_ind_pvm_3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 1712;BA.debugLine="scrResultados.Panel.Height = orden * 90dip";
mostCurrent._scrresultados.getPanel().setHeight((int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90))));
 //BA.debugLineNum = 1713;BA.debugLine="orden = orden +1";
_orden = (int) (_orden+1);
 };
 };
 //BA.debugLineNum = 1718;BA.debugLine="If ind_pvm_4 <> \"NS\" And ind_pvm_4 <> \"\" Then";
if ((mostCurrent._ind_pvm_4).equals("NS") == false && (mostCurrent._ind_pvm_4).equals("") == false) { 
 //BA.debugLineNum = 1719;BA.debugLine="If ind_pvm_4 < 10 Then";
if ((double)(Double.parseDouble(mostCurrent._ind_pvm_4))<10) { 
 //BA.debugLineNum = 1720;BA.debugLine="lbl_ind_pvm_4.Text = \"Hay ligustros, una especi";
_lbl_ind_pvm_4.setText(BA.ObjectToCharSequence("Hay ligustros, una especie altamente invasora!"));
 //BA.debugLineNum = 1721;BA.debugLine="img_ind_pvm_4.Bitmap = LoadBitmapSample(File.Di";
_img_ind_pvm_4.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMM.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1722;BA.debugLine="scrResultados.Panel.AddView(img_ind_pvm_4, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_ind_pvm_4.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1723;BA.debugLine="scrResultados.Panel.AddView(lbl_ind_pvm_4, 50di";
...
_orden = (int) (_orden+1);
 ...
 //BA.debugLineNum = 1727;BA.debugLine="lbl_ind_pvm_4.Text = \"No hay ligustros, una esp";
_lbl_ind_pvm_4.setText(BA.ObjectToCharSequence("No hay ligustros, una especie altamente invasora"));
 //BA.debugLineNum = 1728;BA.debugLine="img_ind_pvm_4.Bitmap = LoadBitmapSample(File.Di";
_img_ind_pvm_4.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"vinetaMB.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)).getObject()));
 //BA.debugLineNum = 1729;BA.debugLine="scrResultados.Panel.AddView(img_ind_pvm_4, 10di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_img_ind_pvm_4.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)));
 //BA.debugLineNum = 1730;BA.debugLine="scrResultados.Panel.AddView(lbl_ind_pvm_4, 50di";
mostCurrent._scrresultados.getPanel().AddView((android.view.View)(_lbl_ind_pvm_4.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)),(int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (70),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 1731;BA.debugLine="scrResultados.Panel.Height = orden * 90dip";
mostCurrent._scrresultados.getPanel().setHeight((int) (_orden*anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90))));
 //BA.debugLineNum = 1732;BA.debugLine="orden = orden +1";
_orden = (int) (_orden+1);
 };
 };
 //BA.debugLineNum = 1737;BA.debugLine="Log(scrResultados.Panel.Height)";
anywheresoftware.b4a.keywords.Common.LogImpl("483820894",BA.NumberToString(mostCurrent._scrresultados.getPanel().getHeight()),0);
...
public ResumableSub_closeScrMsgBox(appear.pnud.preservamos.reporte_habitat_rio_bu parent) {
this.parent = parent;
}
appear.pnud.preservamos.reporte_habitat_rio_bu parent;
int _result = 0;
...
//C
this.state = 1;
 //BA.debugLineNum = 406;BA.debugLine="Msgbox2Async(\"Cerrar la encuesta? No se grabará e";
...
//C
this.state = 4;
 //BA.debugLineNum = 409;BA.debugLine="Activity.RemoveAllViews";
...
public static String  _fondogris_click() throws Exception{
 //BA.debugLineNum = 1760;BA.debugLine="Sub fondogris_Click";
 //BA.debugLineNum = 1761;BA.debugLine="fondogris.RemoveView";
mostCurrent._fondogris.RemoveView();
 //BA.debugLineNum = 1762;BA.debugLine="If mag1.IsInitialized Then";
if (mostCurrent._mag1.IsInitialized()) { 
 //BA.debugLineNum = 1763;BA.debugLine="mag1.RemoveView";
mostCurrent._mag1.RemoveView();
 };
...
mostCurrent._dbutils._updaterecord /*String*/ (mostCurrent.activityBA,mostCurrent._starter._sqldb /*anywheresoftware.b4a.sql.SQL*/ ,"evals","ind_pvm_13",(Object)(mostCurrent._ind_pvm_13),_map1);
 //BA.debugLineNum = 1365;BA.debugLine="DBUtils.UpdateRecord(Starter.sqlDB, \"evals\", \"not";
...
public static String  _imgq1_1_a_click() throws Exception{
 //BA.debugLineNum = 1898;BA.debugLine="Private Sub imgQ1_1_a_Click";
 //BA.debugLineNum = 1900;BA.debugLine="valorind9 = 0";
mostCurrent._valorind9 = BA.NumberToString(0);
 //BA.debugLineNum = 1901;BA.debugLine="lblRojo_Q1.Left = imgQ1_1_a.Left";
mostCurrent._lblrojo_q1.setLeft(mostCurrent._imgq1_1_a.getLeft());
 //BA.debugLineNum = 1902;BA.debugLine="lblRojo_Q1.Top = imgQ1_1_a.Top + imgQ1_1_a.Height";
mostCurrent._lblrojo_q1.setTop((int) (mostCurrent._imgq1_1_a.getTop()+mostCurrent._imgq1_1_a.getHeight()/(double)2));
 //BA.debugLineNum = 1903;BA.debugLine="lblRojo_Q1.Visible = True";
mostCurrent._lblrojo_q1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1904;BA.debugLine="imgRio_desbordado.Visible = True";
mostCurrent._imgrio_desbordado.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1905;BA.debugLine="desbordado = True";
...
public static String  _imgq1_1_b_click() throws Exception{
 //BA.debugLineNum = 1907;BA.debugLine="Private Sub imgQ1_1_b_Click";
 //BA.debugLineNum = 1908;BA.debugLine="valorind9 = 10";
mostCurrent._valorind9 = BA.NumberToString(10);
 //BA.debugLineNum = 1909;BA.debugLine="lblRojo_Q1.Left = imgQ1_1_b.Left";
mostCurrent._lblrojo_q1.setLeft(mostCurrent._imgq1_1_b.getLeft());
 //BA.debugLineNum = 1910;BA.debugLine="lblRojo_Q1.Top = imgQ1_1_b.Top + imgQ1_1_b.Height";
mostCurrent._lblrojo_q1.setTop((int) (mostCurrent._imgq1_1_b.getTop()+mostCurrent._imgq1_1_b.getHeight()/(double)2));
 //BA.debugLineNum = 1911;BA.debugLine="lblRojo_Q1.Visible = True";
mostCurrent._lblrojo_q1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1912;BA.debugLine="imgRio_desbordado.Visible = False";
mostCurrent._imgrio_desbordado.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1913;BA.debugLine="desbordado = False";
...
public static String  _imgq1_1_c_click() throws Exception{
 //BA.debugLineNum = 1915;BA.debugLine="Private Sub imgQ1_1_c_Click";
 //BA.debugLineNum = 1916;BA.debugLine="valorind9 = \"NS\"";
mostCurrent._valorind9 = "NS";
 //BA.debugLineNum = 1917;BA.debugLine="lblRojo_Q1.Left = imgQ1_1_c.Left";
mostCurrent._lblrojo_q1.setLeft(mostCurrent._imgq1_1_c.getLeft());
 //BA.debugLineNum = 1918;BA.debugLine="lblRojo_Q1.Top = imgQ1_1_c.Top + imgQ1_1_c.Height";
mostCurrent._lblrojo_q1.setTop((int) (mostCurrent._imgq1_1_c.getTop()+mostCurrent._imgq1_1_c.getHeight()/(double)2));
 //BA.debugLineNum = 1919;BA.debugLine="lblRojo_Q1.Visible = True";
mostCurrent._lblrojo_q1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1920;BA.debugLine="imgRio_desbordado.Visible = False";
mostCurrent._imgrio_desbordado.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1921;BA.debugLine="desbordado = False";
_desbordado = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1922;BA.debugLine="End Sub";
return "";
}
public static String  _imgq1_2_a_click() throws Exception{
 //BA.debugLineNum = 1925;BA.debugLine="Private Sub imgQ1_2_a_Click";
 //BA.debugLineNum = 1926;BA.debugLine="valorind10 = 0";
mostCurrent._valorind10 = BA.NumberToString(0);
 //BA.debugLineNum = 1927;BA.debugLine="lblRojo_Q1p2.Left = imgQ1_2_a.Left";
mostCurrent._lblrojo_q1p2.setLeft(mostCurrent._imgq1_2_a.getLeft());
 //BA.debugLineNum = 1928;BA.debugLine="lblRojo_Q1p2.Top = imgQ1_2_a.Top + imgQ1_2_a.Heig";
mostCurrent._lblrojo_q1p2.setTop((int) (mostCurrent._imgq1_2_a.getTop()+mostCurrent._imgq1_2_a.getHeight()/(double)2));
 //BA.debugLineNum = 1929;BA.debugLine="lblRojo_Q1p2.Visible = True";
mostCurrent._lblrojo_q1p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1930;BA.debugLine="imgEntubado.Visible = True";
...
public static String  _imgq1_2_b_click() throws Exception{
 //BA.debugLineNum = 1932;BA.debugLine="Private Sub imgQ1_2_b_Click";
 //BA.debugLineNum = 1933;BA.debugLine="valorind10 = 10";
mostCurrent._valorind10 = BA.NumberToString(10);
 //BA.debugLineNum = 1934;BA.debugLine="lblRojo_Q1p2.Left = imgQ1_2_b.Left";
mostCurrent._lblrojo_q1p2.setLeft(mostCurrent._imgq1_2_b.getLeft());
 //BA.debugLineNum = 1935;BA.debugLine="lblRojo_Q1p2.Top = imgQ1_2_b.Top + imgQ1_2_b.Heig";
mostCurrent._lblrojo_q1p2.setTop((int) (mostCurrent._imgq1_2_b.getTop()+mostCurrent._imgq1_2_b.getHeight()/(double)2));
 //BA.debugLineNum = 1936;BA.debugLine="lblRojo_Q1p2.Visible = True";
mostCurrent._lblrojo_q1p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1937;BA.debugLine="imgEntubado.Visible = False";
...
public static String  _imgq1_2_c_click() throws Exception{
 //BA.debugLineNum = 1939;BA.debugLine="Private Sub imgQ1_2_c_Click";
 //BA.debugLineNum = 1940;BA.debugLine="valorind10 = \"NS\"";
mostCurrent._valorind10 = "NS";
 //BA.debugLineNum = 1941;BA.debugLine="lblRojo_Q1p2.Left = imgQ1_2_c.Left";
mostCurrent._lblrojo_q1p2.setLeft(mostCurrent._imgq1_2_c.getLeft());
 //BA.debugLineNum = 1942;BA.debugLine="lblRojo_Q1p2.Top = imgQ1_2_c.Top + imgQ1_2_c.Heig";
mostCurrent._lblrojo_q1p2.setTop((int) (mostCurrent._imgq1_2_c.getTop()+mostCurrent._imgq1_2_c.getHeight()/(double)2));
 //BA.debugLineNum = 1943;BA.debugLine="lblRojo_Q1p2.Visible = True";
mostCurrent._lblrojo_q1p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1944;BA.debugLine="imgEntubado.Visible = False";
mostCurrent._imgentubado.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1945;BA.debugLine="End Sub";
return "";
}
public static String  _imgq2_1_a_click() throws Exception{
 //BA.debugLineNum = 1963;BA.debugLine="Private Sub imgQ2_1_a_Click";
 //BA.debugLineNum = 1964;BA.debugLine="valorind5 = 10";
mostCurrent._valorind5 = BA.NumberToString(10);
 //BA.debugLineNum = 1965;BA.debugLine="lblRojo_Q2p2.Left = imgQ2_1_a.Left";
mostCurrent._lblrojo_q2p2.setLeft(mostCurrent._imgq2_1_a.getLeft());
 //BA.debugLineNum = 1966;BA.debugLine="lblRojo_Q2p2.Top = imgQ2_1_a.Top + imgQ2_1_a.Heig";
mostCurrent._lblrojo_q2p2.setTop((int) (mostCurrent._imgq2_1_a.getTop()+mostCurrent._imgq2_1_a.getHeight()/(double)2));
 //BA.debugLineNum = 1967;BA.debugLine="lblRojo_Q2p2.Visible = True";
mostCurrent._lblrojo_q2p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1968;BA.debugLine="imgRio.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
mostCurrent._imgrio.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rio_Grande_Rio_Marron.png").getObject()));
 //BA.debugLineNum = 1969;BA.debugLine="If desbordado = True Then";
if (_desbordado==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1970;BA.debugLine="imgRio_desbordado.Bitmap = LoadBitmap(File.DirAs";
...
public static String  _imgq2_1_b_click() throws Exception{
 //BA.debugLineNum = 1973;BA.debugLine="Private Sub imgQ2_1_b_Click";
 //BA.debugLineNum = 1974;BA.debugLine="valorind5 = 0";
mostCurrent._valorind5 = BA.NumberToString(0);
 //BA.debugLineNum = 1975;BA.debugLine="lblRojo_Q2p2.Left = imgQ2_1_b.Left";
mostCurrent._lblrojo_q2p2.setLeft(mostCurrent._imgq2_1_b.getLeft());
 //BA.debugLineNum = 1976;BA.debugLine="lblRojo_Q2p2.Top = imgQ2_1_b.Top + imgQ2_1_b.Heig";
mostCurrent._lblrojo_q2p2.setTop((int) (mostCurrent._imgq2_1_b.getTop()+mostCurrent._imgq2_1_b.getHeight()/(double)2));
 //BA.debugLineNum = 1977;BA.debugLine="lblRojo_Q2p2.Visible = True";
mostCurrent._lblrojo_q2p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1978;BA.debugLine="imgRio.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
mostCurrent._imgrio.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rio_Grande_Rio_Negro.png").getObject()));
 //BA.debugLineNum = 1979;BA.debugLine="If desbordado = True Then";
if (_desbordado==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1980;BA.debugLine="imgRio_desbordado.Bitmap = LoadBitmap(File.DirAs";
...
public static String  _imgq2_1_c_click() throws Exception{
 //BA.debugLineNum = 1983;BA.debugLine="Private Sub imgQ2_1_c_Click";
 //BA.debugLineNum = 1984;BA.debugLine="valorind5 = \"NS\"";
mostCurrent._valorind5 = "NS";
 //BA.debugLineNum = 1985;BA.debugLine="lblRojo_Q2p2.Left = imgQ2_1_c.Left";
mostCurrent._lblrojo_q2p2.setLeft(mostCurrent._imgq2_1_c.getLeft());
 //BA.debugLineNum = 1986;BA.debugLine="lblRojo_Q2p2.Top = imgQ2_1_c.Top + imgQ2_1_c.Heig";
mostCurrent._lblrojo_q2p2.setTop((int) (mostCurrent._imgq2_1_c.getTop()+mostCurrent._imgq2_1_c.getHeight()/(double)2));
 //BA.debugLineNum = 1987;BA.debugLine="lblRojo_Q2p2.Visible = True";
mostCurrent._lblrojo_q2p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1988;BA.debugLine="imgRio.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
mostCurrent._imgrio.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rio_Grande.png").getObject()));
 //BA.debugLineNum = 1989;BA.debugLine="If desbordado = True Then";
if (_desbordado==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 1990;BA.debugLine="imgRio_desbordado.Bitmap = LoadBitmap(File.DirAs";
...
public static String  _imgq2_1_no_click() throws Exception{
 //BA.debugLineNum = 1955;BA.debugLine="Private Sub imgQ2_1_no_Click";
 //BA.debugLineNum = 1956;BA.debugLine="valorind5 = \"\"";
mostCurrent._valorind5 = "";
 //BA.debugLineNum = 1957;BA.debugLine="lblRojo_Q2.Left = imgQ2_1_no.Left";
mostCurrent._lblrojo_q2.setLeft(mostCurrent._imgq2_1_no.getLeft());
 //BA.debugLineNum = 1958;BA.debugLine="lblRojo_Q2.Top = imgQ2_1_no.Top + imgQ2_1_no.Heig";
mostCurrent._lblrojo_q2.setTop((int) (mostCurrent._imgq2_1_no.getTop()+mostCurrent._imgq2_1_no.getHeight()/(double)2));
 //BA.debugLineNum = 1959;BA.debugLine="lblRojo_Q2.Visible = True";
...
public static String  _imgq2_1_si_click() throws Exception{
 //BA.debugLineNum = 1948;BA.debugLine="Private Sub imgQ2_1_si_Click";
 //BA.debugLineNum = 1949;BA.debugLine="valorind5 = 10";
mostCurrent._valorind5 = BA.NumberToString(10);
 //BA.debugLineNum = 1950;BA.debugLine="lblRojo_Q2.Left = imgQ2_1_si.Left";
mostCurrent._lblrojo_q2.setLeft(mostCurrent._imgq2_1_si.getLeft());
 //BA.debugLineNum = 1951;BA.debugLine="lblRojo_Q2.Top = imgQ2_1_si.Top + imgQ2_1_si.Heig";
mostCurrent._lblrojo_q2.setTop((int) (mostCurrent._imgq2_1_si.getTop()+mostCurrent._imgq2_1_si.getHeight()/(double)2));
 //BA.debugLineNum = 1952;BA.debugLine="lblRojo_Q2.Visible = True";
mostCurrent._lblrojo_q2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1953;BA.debugLine="imgRio.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
mostCurrent._imgrio.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rio_Grande.png").getObject()));
 //BA.debugLineNum = 1954;BA.debugLine="End Sub";
return "";
}
public static String  _imgq2_3_no_click() throws Exception{
 //BA.debugLineNum = 2000;BA.debugLine="Private Sub imgQ2_3_no_Click";
 //BA.debugLineNum = 2001;BA.debugLine="valorind6 = 10";
mostCurrent._valorind6 = BA.NumberToString(10);
 //BA.debugLineNum = 2002;BA.debugLine="lblRojo_Q2p3.Left = imgQ2_3_no.Left";
mostCurrent._lblrojo_q2p3.setLeft(mostCurrent._imgq2_3_no.getLeft());
 //BA.debugLineNum = 2003;BA.debugLine="lblRojo_Q2p3.Top = imgQ2_3_no.Top + imgQ2_3_no.He";
mostCurrent._lblrojo_q2p3.setTop((int) (mostCurrent._imgq2_3_no.getTop()+mostCurrent._imgq2_3_no.getHeight()/(double)2));
 //BA.debugLineNum = 2004;BA.debugLine="lblRojo_Q2p3.Visible = True";
...
public static String  _imgq2_3_si_click() throws Exception{
 //BA.debugLineNum = 1994;BA.debugLine="Private Sub imgQ2_3_si_Click";
 //BA.debugLineNum = 1995;BA.debugLine="valorind6 = 0";
mostCurrent._valorind6 = BA.NumberToString(0);
 //BA.debugLineNum = 1996;BA.debugLine="lblRojo_Q2p3.Left = imgQ2_3_si.Left";
mostCurrent._lblrojo_q2p3.setLeft(mostCurrent._imgq2_3_si.getLeft());
 //BA.debugLineNum = 1997;BA.debugLine="lblRojo_Q2p3.Top = imgQ2_3_si.Top + imgQ2_3_si.He";
mostCurrent._lblrojo_q2p3.setTop((int) (mostCurrent._imgq2_3_si.getTop()+mostCurrent._imgq2_3_si.getHeight()/(double)2));
 //BA.debugLineNum = 1998;BA.debugLine="lblRojo_Q2p3.Visible = True";
mostCurrent._lblrojo_q2p3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1999;BA.debugLine="End Sub";
return "";
}
public static String  _imgq2_4_no_click() throws Exception{
 //BA.debugLineNum = 2014;BA.debugLine="Private Sub imgQ2_4_no_Click";
 //BA.debugLineNum = 2015;BA.debugLine="ind_pvm_1 = 10";
mostCurrent._ind_pvm_1 = BA.NumberToString(10);
 //BA.debugLineNum = 2016;BA.debugLine="lblRojo_Q2p4.Left = imgQ2_4_no.Left";
mostCurrent._lblrojo_q2p4.setLeft(mostCurrent._imgq2_4_no.getLeft());
 //BA.debugLineNum = 2017;BA.debugLine="lblRojo_Q2p4.Top = imgQ2_4_no.Top + imgQ2_4_no.He";
mostCurrent._lblrojo_q2p4.setTop((int) (mostCurrent._imgq2_4_no.getTop()+mostCurrent._imgq2_4_no.getHeight()/(double)2));
 //BA.debugLineNum = 2018;BA.debugLine="lblRojo_Q2p4.Visible = True";
mostCurrent._lblrojo_q2p4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2019;BA.debugLine="imgEspumas.Visible = False";
...
public static String  _imgq2_4_si_click() throws Exception{
 //BA.debugLineNum = 2007;BA.debugLine="Private Sub imgQ2_4_si_Click";
 //BA.debugLineNum = 2008;BA.debugLine="ind_pvm_1 = 0";
mostCurrent._ind_pvm_1 = BA.NumberToString(0);
 //BA.debugLineNum = 2009;BA.debugLine="lblRojo_Q2p4.Left = imgQ2_4_si.Left";
mostCurrent._lblrojo_q2p4.setLeft(mostCurrent._imgq2_4_si.getLeft());
 //BA.debugLineNum = 2010;BA.debugLine="lblRojo_Q2p4.Top = imgQ2_4_si.Top + imgQ2_4_si.He";
mostCurrent._lblrojo_q2p4.setTop((int) (mostCurrent._imgq2_4_si.getTop()+mostCurrent._imgq2_4_si.getHeight()/(double)2));
 //BA.debugLineNum = 2011;BA.debugLine="lblRojo_Q2p4.Visible = True";
mostCurrent._lblrojo_q2p4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2012;BA.debugLine="imgEspumas.Visible = True";
...
public static String  _imgq3_a_click() throws Exception{
 //BA.debugLineNum = 2023;BA.debugLine="Private Sub imgQ3_a_Click";
 //BA.debugLineNum = 2024;BA.debugLine="valorind7 = 7";
mostCurrent._valorind7 = BA.NumberToString(7);
 //BA.debugLineNum = 2025;BA.debugLine="lblRojo_Q3.Left = imgQ3_a.Left";
mostCurrent._lblrojo_q3.setLeft(mostCurrent._imgq3_a.getLeft());
 //BA.debugLineNum = 2026;BA.debugLine="lblRojo_Q3.Top = imgQ3_a.Top + imgQ3_a.Height / 2";
mostCurrent._lblrojo_q3.setTop((int) (mostCurrent._imgq3_a.getTop()+mostCurrent._imgq3_a.getHeight()/(double)2));
 //BA.debugLineNum = 2027;BA.debugLine="lblRojo_Q3.Visible = True";
mostCurrent._lblrojo_q3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2028;BA.debugLine="imgBasura.Visible = True";
...
public static String  _imgq3_b_click() throws Exception{
 //BA.debugLineNum = 2030;BA.debugLine="Private Sub imgQ3_b_Click";
 //BA.debugLineNum = 2031;BA.debugLine="valorind7 = 10";
mostCurrent._valorind7 = BA.NumberToString(10);
 //BA.debugLineNum = 2032;BA.debugLine="lblRojo_Q3.Left = imgQ3_b.Left";
mostCurrent._lblrojo_q3.setLeft(mostCurrent._imgq3_b.getLeft());
 //BA.debugLineNum = 2033;BA.debugLine="lblRojo_Q3.Top = imgQ3_b.Top + imgQ3_b.Height / 2";
mostCurrent._lblrojo_q3.setTop((int) (mostCurrent._imgq3_b.getTop()+mostCurrent._imgq3_b.getHeight()/(double)2));
 //BA.debugLineNum = 2034;BA.debugLine="lblRojo_Q3.Visible = True";
mostCurrent._lblrojo_q3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2035;BA.debugLine="imgBasura.Visible = False";
...
public static String  _imgq3p2_a_click() throws Exception{
 //BA.debugLineNum = 2038;BA.debugLine="Private Sub imgQ3p2_a_Click";
 //BA.debugLineNum = 2039;BA.debugLine="valorind7 = valorind7 - 3";
mostCurrent._valorind7 = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind7))-3);
 //BA.debugLineNum = 2040;BA.debugLine="lblRojo_Q3p2.Left = imgQ3p2_a.Left";
mostCurrent._lblrojo_q3p2.setLeft(mostCurrent._imgq3p2_a.getLeft());
 //BA.debugLineNum = 2041;BA.debugLine="lblRojo_Q3p2.Top = imgQ3p2_a.Top + imgQ3p2_a.Heig";
mostCurrent._lblrojo_q3p2.setTop((int) (mostCurrent._imgq3p2_a.getTop()+mostCurrent._imgq3p2_a.getHeight()/(double)2));
 //BA.debugLineNum = 2042;BA.debugLine="lblRojo_Q3p2.Visible = True";
mostCurrent._lblrojo_q3p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2043;BA.debugLine="haybasura = True";
_haybasura = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 2044;BA.debugLine="frmFelicitaciones.destino = \"residuos\"";
...
public static String  _imgq3p2_b_click() throws Exception{
 //BA.debugLineNum = 2046;BA.debugLine="Private Sub imgQ3p2_b_Click";
 //BA.debugLineNum = 2047;BA.debugLine="lblRojo_Q3p2.Left = imgQ3p2_b.Left";
mostCurrent._lblrojo_q3p2.setLeft(mostCurrent._imgq3p2_b.getLeft());
 //BA.debugLineNum = 2048;BA.debugLine="lblRojo_Q3p2.Top = imgQ3p2_b.Top + imgQ3p2_b.Heig";
mostCurrent._lblrojo_q3p2.setTop((int) (mostCurrent._imgq3p2_b.getTop()+mostCurrent._imgq3p2_b.getHeight()/(double)2));
 //BA.debugLineNum = 2049;BA.debugLine="lblRojo_Q3p2.Visible = True";
mostCurrent._lblrojo_q3p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2050;BA.debugLine="End Sub";
return "";
}
public static String  _imgq3p3_a_click() throws Exception{
 //BA.debugLineNum = 2052;BA.debugLine="Private Sub imgQ3p3_a_Click";
 //BA.debugLineNum = 2053;BA.debugLine="If lblRojo_Q3p3_a.visible = True Then";
if (mostCurrent._lblrojo_q3p3_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2054;BA.debugLine="lblRojo_Q3p3_a.visible = False";
mostCurrent._lblrojo_q3p3_a.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2055;BA.debugLine="imgBasuraRibera.Visible = False";
mostCurrent._imgbasuraribera.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2057;BA.debugLine="lblRojo_Q3p3_a.visible = True";
mostCurrent._lblrojo_q3p3_a.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2058;BA.debugLine="imgBasuraRibera.Visible = True";
...
public static String  _imgq3p3_b_click() throws Exception{
 //BA.debugLineNum = 2061;BA.debugLine="Private Sub imgQ3p3_b_Click";
 //BA.debugLineNum = 2062;BA.debugLine="If lblRojo_Q3p3_b.visible = True Then";
if (mostCurrent._lblrojo_q3p3_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2063;BA.debugLine="lblRojo_Q3p3_b.visible = False";
mostCurrent._lblrojo_q3p3_b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2066;BA.debugLine="lblRojo_Q3p3_b.visible = True";
...
public static String  _imgq3p3_c_click() throws Exception{
 //BA.debugLineNum = 2070;BA.debugLine="Private Sub imgQ3p3_c_Click";
 //BA.debugLineNum = 2071;BA.debugLine="If lblRojo_Q3p3_c.visible = True Then";
if (mostCurrent._lblrojo_q3p3_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2072;BA.debugLine="lblRojo_Q3p3_c.visible = False";
mostCurrent._lblrojo_q3p3_c.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2073;BA.debugLine="imgBasuraRibera_Grande.Visible = False";
mostCurrent._imgbasuraribera_grande.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2075;BA.debugLine="lblRojo_Q3p3_c.visible = True";
mostCurrent._lblrojo_q3p3_c.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2076;BA.debugLine="imgBasuraRibera_Grande.Visible = True";
...
public static String  _imgq3p3_d_click() throws Exception{
 //BA.debugLineNum = 2079;BA.debugLine="Private Sub imgQ3p3_d_Click";
 //BA.debugLineNum = 2080;BA.debugLine="If lblRojo_Q3p3_d.visible = True Then";
if (mostCurrent._lblrojo_q3p3_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2081;BA.debugLine="lblRojo_Q3p3_d.visible = False";
mostCurrent._lblrojo_q3p3_d.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2082;BA.debugLine="imgAutopartes.Visible = False";
mostCurrent._imgautopartes.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2084;BA.debugLine="lblRojo_Q3p3_d.visible = True";
mostCurrent._lblrojo_q3p3_d.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2085;BA.debugLine="imgAutopartes.Visible = True";
...
public static String  _imgq4_2_a_click() throws Exception{
 //BA.debugLineNum = 2089;BA.debugLine="Private Sub imgQ4_2_a_Click";
 //BA.debugLineNum = 2090;BA.debugLine="ind_pvm_2 = 10";
mostCurrent._ind_pvm_2 = BA.NumberToString(10);
 //BA.debugLineNum = 2091;BA.debugLine="lblRojo_Q4_2.Left = imgQ4_2_a.Left";
mostCurrent._lblrojo_q4_2.setLeft(mostCurrent._imgq4_2_a.getLeft());
 //BA.debugLineNum = 2092;BA.debugLine="lblRojo_Q4_2.Top = imgQ4_2_a.Top + imgQ4_2_a.Heig";
mostCurrent._lblrojo_q4_2.setTop((int) (mostCurrent._imgq4_2_a.getTop()+mostCurrent._imgq4_2_a.getHeight()/(double)2));
 //BA.debugLineNum = 2093;BA.debugLine="lblRojo_Q4_2.Visible = True";
mostCurrent._lblrojo_q4_2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2094;BA.debugLine="imgJuncos.Visible = True";
...
public static String  _imgq4_2_b_click() throws Exception{
 //BA.debugLineNum = 2096;BA.debugLine="Private Sub imgQ4_2_b_Click";
 //BA.debugLineNum = 2097;BA.debugLine="ind_pvm_2 = 8";
mostCurrent._ind_pvm_2 = BA.NumberToString(8);
 //BA.debugLineNum = 2098;BA.debugLine="lblRojo_Q4_2.Left = imgQ4_2_b.Left";
mostCurrent._lblrojo_q4_2.setLeft(mostCurrent._imgq4_2_b.getLeft());
 //BA.debugLineNum = 2099;BA.debugLine="lblRojo_Q4_2.Top = imgQ4_2_b.Top + imgQ4_2_b.Heig";
mostCurrent._lblrojo_q4_2.setTop((int) (mostCurrent._imgq4_2_b.getTop()+mostCurrent._imgq4_2_b.getHeight()/(double)2));
 //BA.debugLineNum = 2100;BA.debugLine="lblRojo_Q4_2.Visible = True";
mostCurrent._lblrojo_q4_2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2101;BA.debugLine="imgJuncos.Visible = True";
mostCurrent._imgjuncos.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2102;BA.debugLine="End Sub";
return "";
}
public static String  _imgq4_2_c_click() throws Exception{
 //BA.debugLineNum = 2103;BA.debugLine="Private Sub imgQ4_2_c_Click";
 //BA.debugLineNum = 2104;BA.debugLine="ind_pvm_2 = 0";
mostCurrent._ind_pvm_2 = BA.NumberToString(0);
 //BA.debugLineNum = 2105;BA.debugLine="lblRojo_Q4_2.Left = imgQ4_2_c.Left";
mostCurrent._lblrojo_q4_2.setLeft(mostCurrent._imgq4_2_c.getLeft());
 //BA.debugLineNum = 2106;BA.debugLine="lblRojo_Q4_2.Top = imgQ4_2_c.Top + imgQ4_2_c.Heig";
mostCurrent._lblrojo_q4_2.setTop((int) (mostCurrent._imgq4_2_c.getTop()+mostCurrent._imgq4_2_c.getHeight()/(double)2));
 //BA.debugLineNum = 2107;BA.debugLine="lblRojo_Q4_2.Visible = True";
mostCurrent._lblrojo_q4_2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2108;BA.debugLine="imgJuncos.Visible = False";
...
public static String  _imgq4_2_d_click() throws Exception{
 //BA.debugLineNum = 2110;BA.debugLine="Private Sub imgQ4_2_d_Click";
 //BA.debugLineNum = 2111;BA.debugLine="ind_pvm_2 = \"NS\"";
mostCurrent._ind_pvm_2 = "NS";
 //BA.debugLineNum = 2112;BA.debugLine="lblRojo_Q4_2.Left = imgQ4_2_d.Left";
mostCurrent._lblrojo_q4_2.setLeft(mostCurrent._imgq4_2_d.getLeft());
 //BA.debugLineNum = 2113;BA.debugLine="lblRojo_Q4_2.Top = imgQ4_2_d.Top + imgQ4_2_d.Heig";
mostCurrent._lblrojo_q4_2.setTop((int) (mostCurrent._imgq4_2_d.getTop()+mostCurrent._imgq4_2_d.getHeight()/(double)2));
 //BA.debugLineNum = 2114;BA.debugLine="lblRojo_Q4_2.Visible = True";
mostCurrent._lblrojo_q4_2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2115;BA.debugLine="imgJuncos.Visible = False";
mostCurrent._imgjuncos.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2116;BA.debugLine="End Sub";
return "";
}
public static String  _imgq4_a_click() throws Exception{
 //BA.debugLineNum = 2407;BA.debugLine="Private Sub imgQ4_a_Click";
 //BA.debugLineNum = 2408;BA.debugLine="If lblRojo_Q4_a.visible = True Then";
if (mostCurrent._lblrojo_q4_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2409;BA.debugLine="lblRojo_Q4_a.visible = False";
mostCurrent._lblrojo_q4_a.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2410;BA.debugLine="imgAnimales_patos.Visible = False";
mostCurrent._imganimales_patos.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2412;BA.debugLine="lblRojo_Q4_a.visible = True";
mostCurrent._lblrojo_q4_a.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2413;BA.debugLine="imgAnimales_patos.Visible = True";
...
public static String  _imgq4_b_click() throws Exception{
 //BA.debugLineNum = 2416;BA.debugLine="Private Sub imgQ4_b_Click";
 //BA.debugLineNum = 2417;BA.debugLine="If lblRojo_Q4_b.visible = True Then";
if (mostCurrent._lblrojo_q4_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2418;BA.debugLine="lblRojo_Q4_b.visible = False";
mostCurrent._lblrojo_q4_b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2419;BA.debugLine="imgAnimales_peces.Visible = False";
mostCurrent._imganimales_peces.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2421;BA.debugLine="lblRojo_Q4_b.visible = True";
mostCurrent._lblrojo_q4_b.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2422;BA.debugLine="imgAnimales_peces.Visible = True";
...
public static String  _imgq4_c_click() throws Exception{
 //BA.debugLineNum = 2425;BA.debugLine="Private Sub imgQ4_c_Click";
 //BA.debugLineNum = 2426;BA.debugLine="If lblRojo_Q4_c.visible = True Then";
if (mostCurrent._lblrojo_q4_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2427;BA.debugLine="lblRojo_Q4_c.visible = False";
mostCurrent._lblrojo_q4_c.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2430;BA.debugLine="lblRojo_Q4_c.visible = True";
...
public static String  _imgq4_d_click() throws Exception{
 //BA.debugLineNum = 2434;BA.debugLine="Private Sub imgQ4_d_Click";
 //BA.debugLineNum = 2435;BA.debugLine="If lblRojo_Q4_d.visible = True Then";
if (mostCurrent._lblrojo_q4_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2436;BA.debugLine="lblRojo_Q4_d.visible = False";
mostCurrent._lblrojo_q4_d.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2439;BA.debugLine="lblRojo_Q4_d.visible = True";
...
public static String  _imgq4_e_click() throws Exception{
 //BA.debugLineNum = 2443;BA.debugLine="Private Sub imgQ4_e_Click";
 //BA.debugLineNum = 2444;BA.debugLine="If lblRojo_Q4_e.visible = True Then";
if (mostCurrent._lblrojo_q4_e.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2445;BA.debugLine="lblRojo_Q4_e.visible = False";
mostCurrent._lblrojo_q4_e.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2446;BA.debugLine="imgAnimales_roedores.Visible = False";
mostCurrent._imganimales_roedores.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2448;BA.debugLine="lblRojo_Q4_e.visible = True";
mostCurrent._lblrojo_q4_e.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2449;BA.debugLine="imgAnimales_roedores.Visible = True";
...
public static String  _imgq4_f_click() throws Exception{
 //BA.debugLineNum = 2452;BA.debugLine="Private Sub imgQ4_f_Click";
 //BA.debugLineNum = 2453;BA.debugLine="If lblRojo_Q4_f.visible = True Then";
if (mostCurrent._lblrojo_q4_f.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2454;BA.debugLine="lblRojo_Q4_f.visible = False";
mostCurrent._lblrojo_q4_f.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2455;BA.debugLine="imgAnimales_tortugas.Visible = False";
mostCurrent._imganimales_tortugas.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2457;BA.debugLine="lblRojo_Q4_f.visible = True";
mostCurrent._lblrojo_q4_f.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2458;BA.debugLine="imgAnimales_tortugas.Visible = True";
...
public static String  _imgq4p2_a_click() throws Exception{
 //BA.debugLineNum = 2118;BA.debugLine="Private Sub imgQ4p2_a_Click";
 //BA.debugLineNum = 2119;BA.debugLine="valorind4 = 10";
mostCurrent._valorind4 = BA.NumberToString(10);
 //BA.debugLineNum = 2120;BA.debugLine="lblRojo_Q4p2.Left = imgQ4p2_a.Left";
mostCurrent._lblrojo_q4p2.setLeft(mostCurrent._imgq4p2_a.getLeft());
 //BA.debugLineNum = 2121;BA.debugLine="lblRojo_Q4p2.Top = imgQ4p2_a.Top + imgQ4p2_a.Heig";
mostCurrent._lblrojo_q4p2.setTop((int) (mostCurrent._imgq4p2_a.getTop()+mostCurrent._imgq4p2_a.getHeight()/(double)2));
 //BA.debugLineNum = 2122;BA.debugLine="lblRojo_Q4p2.Visible = True";
mostCurrent._lblrojo_q4p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2123;BA.debugLine="imgPlantasAcuaticas.Visible = True";
...
public static String  _imgq4p2_b_click() throws Exception{
 //BA.debugLineNum = 2125;BA.debugLine="Private Sub imgQ4p2_b_Click";
 //BA.debugLineNum = 2126;BA.debugLine="valorind4 = 8";
mostCurrent._valorind4 = BA.NumberToString(8);
 //BA.debugLineNum = 2127;BA.debugLine="lblRojo_Q4p2.Left = imgQ4p2_b.Left";
mostCurrent._lblrojo_q4p2.setLeft(mostCurrent._imgq4p2_b.getLeft());
 //BA.debugLineNum = 2128;BA.debugLine="lblRojo_Q4p2.Top = imgQ4p2_b.Top + imgQ4p2_b.Heig";
mostCurrent._lblrojo_q4p2.setTop((int) (mostCurrent._imgq4p2_b.getTop()+mostCurrent._imgq4p2_b.getHeight()/(double)2));
 //BA.debugLineNum = 2129;BA.debugLine="lblRojo_Q4p2.Visible = True";
mostCurrent._lblrojo_q4p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2130;BA.debugLine="imgPlantasAcuaticas.Visible = True";
mostCurrent._imgplantasacuaticas.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2131;BA.debugLine="End Sub";
return "";
}
public static String  _imgq4p2_c_click() throws Exception{
 //BA.debugLineNum = 2132;BA.debugLine="Private Sub imgQ4p2_c_Click";
 //BA.debugLineNum = 2133;BA.debugLine="valorind4 = 0";
mostCurrent._valorind4 = BA.NumberToString(0);
 //BA.debugLineNum = 2134;BA.debugLine="lblRojo_Q4p2.Left = imgQ4p2_c.Left";
mostCurrent._lblrojo_q4p2.setLeft(mostCurrent._imgq4p2_c.getLeft());
 //BA.debugLineNum = 2135;BA.debugLine="lblRojo_Q4p2.Top = imgQ4p2_c.Top + imgQ4p2_c.Heig";
mostCurrent._lblrojo_q4p2.setTop((int) (mostCurrent._imgq4p2_c.getTop()+mostCurrent._imgq4p2_c.getHeight()/(double)2));
 //BA.debugLineNum = 2136;BA.debugLine="lblRojo_Q4p2.Visible = True";
mostCurrent._lblrojo_q4p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2137;BA.debugLine="imgPlantasAcuaticas.Visible = False";
...
public static String  _imgq4p2_d_click() throws Exception{
 //BA.debugLineNum = 2139;BA.debugLine="Private Sub imgQ4p2_d_Click";
 //BA.debugLineNum = 2140;BA.debugLine="valorind4 = \"NS\"";
mostCurrent._valorind4 = "NS";
 //BA.debugLineNum = 2141;BA.debugLine="lblRojo_Q4p2.Left = imgQ4p2_d.Left";
mostCurrent._lblrojo_q4p2.setLeft(mostCurrent._imgq4p2_d.getLeft());
 //BA.debugLineNum = 2142;BA.debugLine="lblRojo_Q4p2.Top = imgQ4p2_d.Top + imgQ4p2_d.Heig";
mostCurrent._lblrojo_q4p2.setTop((int) (mostCurrent._imgq4p2_d.getTop()+mostCurrent._imgq4p2_d.getHeight()/(double)2));
 //BA.debugLineNum = 2143;BA.debugLine="lblRojo_Q4p2.Visible = True";
mostCurrent._lblrojo_q4p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2144;BA.debugLine="imgPlantasAcuaticas.Visible = False";
mostCurrent._imgplantasacuaticas.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2145;BA.debugLine="End Sub";
return "";
}
public static String  _imgq5_1_a_click() throws Exception{
 //BA.debugLineNum = 2147;BA.debugLine="Private Sub imgQ5_1_a_Click";
 //BA.debugLineNum = 2148;BA.debugLine="valorind1 = 0";
mostCurrent._valorind1 = BA.NumberToString(0);
 //BA.debugLineNum = 2149;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2150;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_a.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_a.getLeft());
 //BA.debugLineNum = 2151;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_a.Top + imgQ5_1_a.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_a.getTop()+mostCurrent._imgq5_1_a.getHeight()/(double)2));
 //BA.debugLineNum = 2152;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2153;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2154;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_b_click() throws Exception{
 //BA.debugLineNum = 2156;BA.debugLine="Private Sub imgQ5_1_b_Click";
 //BA.debugLineNum = 2157;BA.debugLine="valorind1 = 2";
mostCurrent._valorind1 = BA.NumberToString(2);
 //BA.debugLineNum = 2158;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2159;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_b.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_b.getLeft());
 //BA.debugLineNum = 2160;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_b.Top + imgQ5_1_b.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_b.getTop()+mostCurrent._imgq5_1_b.getHeight()/(double)2));
 //BA.debugLineNum = 2161;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2162;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2163;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_c_click() throws Exception{
 //BA.debugLineNum = 2165;BA.debugLine="Private Sub imgQ5_1_c_Click";
 //BA.debugLineNum = 2166;BA.debugLine="valorind1 = 4";
mostCurrent._valorind1 = BA.NumberToString(4);
 //BA.debugLineNum = 2167;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2168;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_c.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_c.getLeft());
 //BA.debugLineNum = 2169;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_c.Top + imgQ5_1_c.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_c.getTop()+mostCurrent._imgq5_1_c.getHeight()/(double)2));
 //BA.debugLineNum = 2170;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2171;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2172;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_d_click() throws Exception{
 //BA.debugLineNum = 2174;BA.debugLine="Private Sub imgQ5_1_d_Click";
 //BA.debugLineNum = 2175;BA.debugLine="valorind1 = 10";
mostCurrent._valorind1 = BA.NumberToString(10);
 //BA.debugLineNum = 2176;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2177;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_d.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_d.getLeft());
 //BA.debugLineNum = 2178;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_d.Top + imgQ5_1_d.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_d.getTop()+mostCurrent._imgq5_1_d.getHeight()/(double)2));
 //BA.debugLineNum = 2179;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2180;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2181;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_e_click() throws Exception{
 //BA.debugLineNum = 2183;BA.debugLine="Private Sub imgQ5_1_e_Click";
 //BA.debugLineNum = 2184;BA.debugLine="valorind1 = 10";
mostCurrent._valorind1 = BA.NumberToString(10);
 //BA.debugLineNum = 2185;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2186;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_e.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_e.getLeft());
 //BA.debugLineNum = 2187;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_e.Top + imgQ5_1_e.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_e.getTop()+mostCurrent._imgq5_1_e.getHeight()/(double)2));
 //BA.debugLineNum = 2188;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2189;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2190;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_f_click() throws Exception{
 //BA.debugLineNum = 2192;BA.debugLine="Private Sub imgQ5_1_f_Click";
 //BA.debugLineNum = 2193;BA.debugLine="valorind1 = 4";
mostCurrent._valorind1 = BA.NumberToString(4);
 //BA.debugLineNum = 2194;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2195;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_f.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_f.getLeft());
 //BA.debugLineNum = 2196;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_f.Top + imgQ5_1_f.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_f.getTop()+mostCurrent._imgq5_1_f.getHeight()/(double)2));
 //BA.debugLineNum = 2197;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2198;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2199;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_g_click() throws Exception{
 //BA.debugLineNum = 2201;BA.debugLine="Private Sub imgQ5_1_g_Click";
 //BA.debugLineNum = 2202;BA.debugLine="valorind1 = 2";
mostCurrent._valorind1 = BA.NumberToString(2);
 //BA.debugLineNum = 2203;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2204;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_g.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_g.getLeft());
 //BA.debugLineNum = 2205;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_g.Top + imgQ5_1_g.Heig";
mostCurrent._lblrojo_q5_1.setTop((int) (mostCurrent._imgq5_1_g.getTop()+mostCurrent._imgq5_1_g.getHeight()/(double)2));
 //BA.debugLineNum = 2206;BA.debugLine="lblRojo_Q5_1.Visible = True";
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2207;BA.debugLine="imgUso.Visible = True";
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2208;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_h_click() throws Exception{
 //BA.debugLineNum = 2210;BA.debugLine="Private Sub imgQ5_1_h_Click";
 //BA.debugLineNum = 2211;BA.debugLine="haycampo = True";
_haycampo = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 2212;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_h.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_h.getLeft());
 //BA.debugLineNum = 2213;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_h.Top + imgQ5_1_h.Heig";
...
mostCurrent._imguso.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2216;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
...
public static String  _imgq5_1_i_click() throws Exception{
 //BA.debugLineNum = 2218;BA.debugLine="Private Sub imgQ5_1_i_Click";
 //BA.debugLineNum = 2219;BA.debugLine="valorind1 = \"NS\"";
mostCurrent._valorind1 = "NS";
 //BA.debugLineNum = 2220;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2221;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_i.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_i.getLeft());
 //BA.debugLineNum = 2222;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_i.Top + imgQ5_1_i.Heig";
...
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2224;BA.debugLine="imgUso.Visible = False";
...
public static String  _imgq5_1_j_click() throws Exception{
 //BA.debugLineNum = 2226;BA.debugLine="Private Sub imgQ5_1_j_Click";
 //BA.debugLineNum = 2227;BA.debugLine="valorind1 = 0";
mostCurrent._valorind1 = BA.NumberToString(0);
 //BA.debugLineNum = 2228;BA.debugLine="haycampo = False";
_haycampo = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 2229;BA.debugLine="lblRojo_Q5_1.Left = imgQ5_1_j.Left";
mostCurrent._lblrojo_q5_1.setLeft(mostCurrent._imgq5_1_j.getLeft());
 //BA.debugLineNum = 2230;BA.debugLine="lblRojo_Q5_1.Top = imgQ5_1_j.Top + imgQ5_1_j.Heig";
...
mostCurrent._lblrojo_q5_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2232;BA.debugLine="imgUso.Bitmap = LoadBitmap(File.DirAssets, \"Rio_G";
mostCurrent._imguso.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rio_Grande_Ambiente_campo.png").getObject()));
 //BA.debugLineNum = 2233;BA.debugLine="End Sub";
return "";
}
public static String  _imgq5p2_a_click() throws Exception{
 //BA.debugLineNum = 2236;BA.debugLine="Private Sub imgQ5p2_a_Click";
 //BA.debugLineNum = 2237;BA.debugLine="valorind2 = 0";
mostCurrent._valorind2 = BA.NumberToString(0);
 //BA.debugLineNum = 2238;BA.debugLine="lblRojo_Q5p2.Left = imgQ5p2_a.Left";
mostCurrent._lblrojo_q5p2.setLeft(mostCurrent._imgq5p2_a.getLeft());
 //BA.debugLineNum = 2239;BA.debugLine="lblRojo_Q5p2.Top = imgQ5p2_a.Top + imgQ5p2_a.Heig";
mostCurrent._lblrojo_q5p2.setTop((int) (mostCurrent._imgq5p2_a.getTop()+mostCurrent._imgq5p2_a.getHeight()/(double)2));
 //BA.debugLineNum = 2240;BA.debugLine="lblRojo_Q5p2.Visible = True";
mostCurrent._lblrojo_q5p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2241;BA.debugLine="imgUso_Campo2.Visible = True";
mostCurrent._imguso_campo2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2242;BA.debugLine="imgUso_Campo2.Bitmap = LoadBitmap(File.DirAssets,";
...
public static String  _imgq5p2_b_click() throws Exception{
 //BA.debugLineNum = 2244;BA.debugLine="Private Sub imgQ5p2_b_Click";
 //BA.debugLineNum = 2245;BA.debugLine="valorind2 = 4";
mostCurrent._valorind2 = BA.NumberToString(4);
 //BA.debugLineNum = 2246;BA.debugLine="lblRojo_Q5p2.Left = imgQ5p2_b.Left";
mostCurrent._lblrojo_q5p2.setLeft(mostCurrent._imgq5p2_b.getLeft());
 //BA.debugLineNum = 2247;BA.debugLine="lblRojo_Q5p2.Top = imgQ5p2_b.Top + imgQ5p2_b.Heig";
mostCurrent._lblrojo_q5p2.setTop((int) (mostCurrent._imgq5p2_b.getTop()+mostCurrent._imgq5p2_b.getHeight()/(double)2));
 //BA.debugLineNum = 2248;BA.debugLine="lblRojo_Q5p2.Visible = True";
mostCurrent._lblrojo_q5p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2249;BA.debugLine="imgUso_Campo2.Visible = True";
mostCurrent._imguso_campo2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2250;BA.debugLine="imgUso_Campo2.Bitmap = LoadBitmap(File.DirAssets,";
...
public static String  _imgq5p2_c_click() throws Exception{
 //BA.debugLineNum = 2252;BA.debugLine="Private Sub imgQ5p2_c_Click";
 //BA.debugLineNum = 2253;BA.debugLine="valorind2 = 10";
mostCurrent._valorind2 = BA.NumberToString(10);
 //BA.debugLineNum = 2254;BA.debugLine="lblRojo_Q5p2.Left = imgQ5p2_c.Left";
mostCurrent._lblrojo_q5p2.setLeft(mostCurrent._imgq5p2_c.getLeft());
 //BA.debugLineNum = 2255;BA.debugLine="lblRojo_Q5p2.Top = imgQ5p2_c.Top + imgQ5p2_c.Heig";
mostCurrent._lblrojo_q5p2.setTop((int) (mostCurrent._imgq5p2_c.getTop()+mostCurrent._imgq5p2_c.getHeight()/(double)2));
 //BA.debugLineNum = 2256;BA.debugLine="lblRojo_Q5p2.Visible = True";
mostCurrent._lblrojo_q5p2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2257;BA.debugLine="imgUso_Campo2.Visible = False";
mostCurrent._imguso_campo2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2258;BA.debugLine="imgUso_Campo2.Visible = False";
mostCurrent._imguso_campo2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2260;BA.debugLine="End Sub";
return "";
}
public static String  _imgq5p3_a_click() throws Exception{
 //BA.debugLineNum = 2263;BA.debugLine="Private Sub imgQ5p3_a_Click";
 //BA.debugLineNum = 2264;BA.debugLine="valorind1 = 2";
mostCurrent._valorind1 = BA.NumberToString(2);
 //BA.debugLineNum = 2265;BA.debugLine="lblRojo_Q5p3.Left = imgQ5p3_a.Left";
mostCurrent._lblrojo_q5p3.setLeft(mostCurrent._imgq5p3_a.getLeft());
 //BA.debugLineNum = 2266;BA.debugLine="lblRojo_Q5p3.Top = imgQ5p3_a.Top + imgQ5p3_a.Heig";
mostCurrent._lblrojo_q5p3.setTop((int) (mostCurrent._imgq5p3_a.getTop()+mostCurrent._imgq5p3_a.getHeight()/(double)2));
 //BA.debugLineNum = 2267;BA.debugLine="lblRojo_Q5p3.Visible = True";
mostCurrent._lblrojo_q5p3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2268;BA.debugLine="imgUso_Campo1.Visible = True";
mostCurrent._imguso_campo1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2269;BA.debugLine="imgUso_Campo1.Bitmap = LoadBitmap(File.DirAssets,";
...
public static String  _imgq5p3_b_click() throws Exception{
 //BA.debugLineNum = 2271;BA.debugLine="Private Sub imgQ5p3_b_Click";
 //BA.debugLineNum = 2272;BA.debugLine="valorind1 = 2";
mostCurrent._valorind1 = BA.NumberToString(2);
 //BA.debugLineNum = 2273;BA.debugLine="lblRojo_Q5p3.Left = imgQ5p3_b.Left";
mostCurrent._lblrojo_q5p3.setLeft(mostCurrent._imgq5p3_b.getLeft());
 //BA.debugLineNum = 2274;BA.debugLine="lblRojo_Q5p3.Top = imgQ5p3_b.Top + imgQ5p3_b.Heig";
mostCurrent._lblrojo_q5p3.setTop((int) (mostCurrent._imgq5p3_b.getTop()+mostCurrent._imgq5p3_b.getHeight()/(double)2));
 //BA.debugLineNum = 2275;BA.debugLine="lblRojo_Q5p3.Visible = True";
mostCurrent._lblrojo_q5p3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2276;BA.debugLine="imgUso_Campo1.Visible = True";
mostCurrent._imguso_campo1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2277;BA.debugLine="imgUso_Campo1.Bitmap = LoadBitmap(File.DirAssets,";
...
public static String  _imgq5p3_c_click() throws Exception{
 //BA.debugLineNum = 2279;BA.debugLine="Private Sub imgQ5p3_c_Click";
 //BA.debugLineNum = 2280;BA.debugLine="valorind1 = 6";
mostCurrent._valorind1 = BA.NumberToString(6);
 //BA.debugLineNum = 2281;BA.debugLine="lblRojo_Q5p3.Left = imgQ5p3_c.Left";
mostCurrent._lblrojo_q5p3.setLeft(mostCurrent._imgq5p3_c.getLeft());
 //BA.debugLineNum = 2282;BA.debugLine="lblRojo_Q5p3.Top = imgQ5p3_c.Top + imgQ5p3_c.Heig";
mostCurrent._lblrojo_q5p3.setTop((int) (mostCurrent._imgq5p3_c.getTop()+mostCurrent._imgq5p3_c.getHeight()/(double)2));
 //BA.debugLineNum = 2283;BA.debugLine="lblRojo_Q5p3.Visible = True";
mostCurrent._lblrojo_q5p3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2284;BA.debugLine="imgUso_Campo1.Visible = True";
mostCurrent._imguso_campo1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2285;BA.debugLine="imgUso_Campo1.Bitmap = LoadBitmap(File.DirAssets,";
...
public static String  _imgq5p3_d_click() throws Exception{
 //BA.debugLineNum = 2287;BA.debugLine="Private Sub imgQ5p3_d_Click";
 //BA.debugLineNum = 2288;BA.debugLine="valorind1 = 10";
mostCurrent._valorind1 = BA.NumberToString(10);
 //BA.debugLineNum = 2289;BA.debugLine="lblRojo_Q5p3.Left = imgQ5p3_d.Left";
mostCurrent._lblrojo_q5p3.setLeft(mostCurrent._imgq5p3_d.getLeft());
 //BA.debugLineNum = 2290;BA.debugLine="lblRojo_Q5p3.Top = imgQ5p3_d.Top + imgQ5p3_d.Heig";
mostCurrent._lblrojo_q5p3.setTop((int) (mostCurrent._imgq5p3_d.getTop()+mostCurrent._imgq5p3_d.getHeight()/(double)2));
 //BA.debugLineNum = 2291;BA.debugLine="lblRojo_Q5p3.Visible = True";
mostCurrent._lblrojo_q5p3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2292;BA.debugLine="imgUso_Campo1.Visible = False";
...
public static String  _imgq6_1_a_click() throws Exception{
 //BA.debugLineNum = 2349;BA.debugLine="Private Sub imgQ6_1_a_Click";
 //BA.debugLineNum = 2350;BA.debugLine="ind_pvm_3 = 0";
mostCurrent._ind_pvm_3 = BA.NumberToString(0);
 //BA.debugLineNum = 2351;BA.debugLine="lblRojo_Q6_1.Left = imgQ6_1_a.Left";
mostCurrent._lblrojo_q6_1.setLeft(mostCurrent._imgq6_1_a.getLeft());
 //BA.debugLineNum = 2352;BA.debugLine="lblRojo_Q6_1.Top = imgQ6_1_a.Top + imgQ6_1_a.Heig";
mostCurrent._lblrojo_q6_1.setTop((int) (mostCurrent._imgq6_1_a.getTop()+mostCurrent._imgq6_1_a.getHeight()/(double)2));
 //BA.debugLineNum = 2353;BA.debugLine="lblRojo_Q6_1.Visible = True";
mostCurrent._lblrojo_q6_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2354;BA.debugLine="imgAcacia.Visible = True";
...
public static String  _imgq6_1_b_click() throws Exception{
 //BA.debugLineNum = 2356;BA.debugLine="Private Sub imgQ6_1_b_Click";
 //BA.debugLineNum = 2357;BA.debugLine="ind_pvm_3 = 2";
mostCurrent._ind_pvm_3 = BA.NumberToString(2);
 //BA.debugLineNum = 2358;BA.debugLine="lblRojo_Q6_1.Left = imgQ6_1_b.Left";
mostCurrent._lblrojo_q6_1.setLeft(mostCurrent._imgq6_1_b.getLeft());
 //BA.debugLineNum = 2359;BA.debugLine="lblRojo_Q6_1.Top = imgQ6_1_b.Top + imgQ6_1_b.Heig";
mostCurrent._lblrojo_q6_1.setTop((int) (mostCurrent._imgq6_1_b.getTop()+mostCurrent._imgq6_1_b.getHeight()/(double)2));
 //BA.debugLineNum = 2360;BA.debugLine="lblRojo_Q6_1.Visible = True";
mostCurrent._lblrojo_q6_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2361;BA.debugLine="imgAcacia.Visible = True";
mostCurrent._imgacacia.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2362;BA.debugLine="End Sub";
return "";
}
public static String  _imgq6_1_c_click() throws Exception{
 //BA.debugLineNum = 2363;BA.debugLine="Private Sub imgQ6_1_c_Click";
 //BA.debugLineNum = 2364;BA.debugLine="ind_pvm_3 = 10";
mostCurrent._ind_pvm_3 = BA.NumberToString(10);
 //BA.debugLineNum = 2365;BA.debugLine="lblRojo_Q6_1.Left = imgQ6_1_c.Left";
mostCurrent._lblrojo_q6_1.setLeft(mostCurrent._imgq6_1_c.getLeft());
 //BA.debugLineNum = 2366;BA.debugLine="lblRojo_Q6_1.Top = imgQ6_1_c.Top + imgQ6_1_c.Heig";
mostCurrent._lblrojo_q6_1.setTop((int) (mostCurrent._imgq6_1_c.getTop()+mostCurrent._imgq6_1_c.getHeight()/(double)2));
 //BA.debugLineNum = 2367;BA.debugLine="lblRojo_Q6_1.Visible = True";
mostCurrent._lblrojo_q6_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2368;BA.debugLine="imgAcacia.Visible = False";
...
public static String  _imgq6_1_d_click() throws Exception{
 //BA.debugLineNum = 2370;BA.debugLine="Private Sub imgQ6_1_d_Click";
 //BA.debugLineNum = 2371;BA.debugLine="ind_pvm_3 = \"NS\"";
mostCurrent._ind_pvm_3 = "NS";
 //BA.debugLineNum = 2372;BA.debugLine="lblRojo_Q6_1.Left = imgQ6_1_d.Left";
mostCurrent._lblrojo_q6_1.setLeft(mostCurrent._imgq6_1_d.getLeft());
 //BA.debugLineNum = 2373;BA.debugLine="lblRojo_Q6_1.Top = imgQ6_1_d.Top + imgQ6_1_d.Heig";
mostCurrent._lblrojo_q6_1.setTop((int) (mostCurrent._imgq6_1_d.getTop()+mostCurrent._imgq6_1_d.getHeight()/(double)2));
 //BA.debugLineNum = 2374;BA.debugLine="lblRojo_Q6_1.Visible = True";
mostCurrent._lblrojo_q6_1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2375;BA.debugLine="imgAcacia.Visible = False";
mostCurrent._imgacacia.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2376;BA.debugLine="End Sub";
return "";
}
public static String  _imgq6_3_a_click() throws Exception{
 //BA.debugLineNum = 2378;BA.debugLine="Private Sub imgQ6_3_a_Click";
 //BA.debugLineNum = 2379;BA.debugLine="ind_pvm_4 = 0";
mostCurrent._ind_pvm_4 = BA.NumberToString(0);
 //BA.debugLineNum = 2380;BA.debugLine="lblRojo_Q6_3.Left = imgQ6_3_a.Left";
mostCurrent._lblrojo_q6_3.setLeft(mostCurrent._imgq6_3_a.getLeft());
 //BA.debugLineNum = 2381;BA.debugLine="lblRojo_Q6_3.Top = imgQ6_3_a.Top + imgQ6_3_a.Heig";
mostCurrent._lblrojo_q6_3.setTop((int) (mostCurrent._imgq6_3_a.getTop()+mostCurrent._imgq6_3_a.getHeight()/(double)2));
 //BA.debugLineNum = 2382;BA.debugLine="lblRojo_Q6_3.Visible = True";
mostCurrent._lblrojo_q6_3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2383;BA.debugLine="imgLigustro.Visible = True";
...
public static String  _imgq6_3_b_click() throws Exception{
 //BA.debugLineNum = 2385;BA.debugLine="Private Sub imgQ6_3_b_Click";
 //BA.debugLineNum = 2386;BA.debugLine="ind_pvm_4 = 2";
mostCurrent._ind_pvm_4 = BA.NumberToString(2);
 //BA.debugLineNum = 2387;BA.debugLine="lblRojo_Q6_3.Left = imgQ6_3_b.Left";
mostCurrent._lblrojo_q6_3.setLeft(mostCurrent._imgq6_3_b.getLeft());
 //BA.debugLineNum = 2388;BA.debugLine="lblRojo_Q6_3.Top = imgQ6_3_b.Top + imgQ6_3_b.Heig";
mostCurrent._lblrojo_q6_3.setTop((int) (mostCurrent._imgq6_3_b.getTop()+mostCurrent._imgq6_3_b.getHeight()/(double)2));
 //BA.debugLineNum = 2389;BA.debugLine="lblRojo_Q6_3.Visible = True";
mostCurrent._lblrojo_q6_3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2390;BA.debugLine="imgLigustro.Visible = True";
mostCurrent._imgligustro.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2391;BA.debugLine="End Sub";
return "";
}
public static String  _imgq6_3_c_click() throws Exception{
 //BA.debugLineNum = 2392;BA.debugLine="Private Sub imgQ6_3_c_Click";
 //BA.debugLineNum = 2393;BA.debugLine="ind_pvm_4 = 10";
mostCurrent._ind_pvm_4 = BA.NumberToString(10);
 //BA.debugLineNum = 2394;BA.debugLine="lblRojo_Q6_3.Left = imgQ6_3_c.Left";
mostCurrent._lblrojo_q6_3.setLeft(mostCurrent._imgq6_3_c.getLeft());
 //BA.debugLineNum = 2395;BA.debugLine="lblRojo_Q6_3.Top = imgQ6_3_c.Top + imgQ6_3_c.Heig";
mostCurrent._lblrojo_q6_3.setTop((int) (mostCurrent._imgq6_3_c.getTop()+mostCurrent._imgq6_3_c.getHeight()/(double)2));
 //BA.debugLineNum = 2396;BA.debugLine="lblRojo_Q6_3.Visible = True";
mostCurrent._lblrojo_q6_3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2397;BA.debugLine="imgLigustro.Visible = False";
...
public static String  _imgq6_3_d_click() throws Exception{
 //BA.debugLineNum = 2399;BA.debugLine="Private Sub imgQ6_3_d_Click";
 //BA.debugLineNum = 2400;BA.debugLine="ind_pvm_4 = \"NS\"";
mostCurrent._ind_pvm_4 = "NS";
 //BA.debugLineNum = 2401;BA.debugLine="lblRojo_Q6_3.Left = imgQ6_3_d.Left";
mostCurrent._lblrojo_q6_3.setLeft(mostCurrent._imgq6_3_d.getLeft());
 //BA.debugLineNum = 2402;BA.debugLine="lblRojo_Q6_3.Top = imgQ6_3_d.Top + imgQ6_3_d.Heig";
mostCurrent._lblrojo_q6_3.setTop((int) (mostCurrent._imgq6_3_d.getTop()+mostCurrent._imgq6_3_d.getHeight()/(double)2));
 //BA.debugLineNum = 2403;BA.debugLine="lblRojo_Q6_3.Visible = True";
mostCurrent._lblrojo_q6_3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2404;BA.debugLine="imgLigustro.Visible = False";
mostCurrent._imgligustro.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2405;BA.debugLine="End Sub";
return "";
}
public static String  _imgq6_a_click() throws Exception{
 //BA.debugLineNum = 2296;BA.debugLine="Private Sub imgQ6_a_Click";
 //BA.debugLineNum = 2297;BA.debugLine="If lblRojo_Q6_a.visible = True Then";
if (mostCurrent._lblrojo_q6_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2298;BA.debugLine="lblRojo_Q6_a.visible = False";
mostCurrent._lblrojo_q6_a.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2299;BA.debugLine="imgArboles.Visible = False";
mostCurrent._imgarboles.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2301;BA.debugLine="lblRojo_Q6_a.visible = True";
mostCurrent._lblrojo_q6_a.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2302;BA.debugLine="imgArboles.Visible = True";
...
public static String  _imgq6_b_click() throws Exception{
 //BA.debugLineNum = 2305;BA.debugLine="Private Sub imgQ6_b_Click";
 //BA.debugLineNum = 2306;BA.debugLine="If lblRojo_Q6_b.visible = True Then";
if (mostCurrent._lblrojo_q6_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2307;BA.debugLine="lblRojo_Q6_b.visible = False";
mostCurrent._lblrojo_q6_b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2308;BA.debugLine="imgArbustos.Visible = False";
mostCurrent._imgarbustos.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2310;BA.debugLine="lblRojo_Q6_b.visible = True";
mostCurrent._lblrojo_q6_b.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2311;BA.debugLine="imgArbustos.Visible = True";
...
public static String  _imgq6_c_click() throws Exception{
 //BA.debugLineNum = 2314;BA.debugLine="Private Sub imgQ6_c_Click";
 //BA.debugLineNum = 2315;BA.debugLine="If lblRojo_Q6_c.visible = True Then";
if (mostCurrent._lblrojo_q6_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2316;BA.debugLine="lblRojo_Q6_c.visible = False";
mostCurrent._lblrojo_q6_c.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2317;BA.debugLine="imgPastoLargo.Visible = False";
mostCurrent._imgpastolargo.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2319;BA.debugLine="lblRojo_Q6_c.visible = True";
mostCurrent._lblrojo_q6_c.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2320;BA.debugLine="imgPastoLargo.Visible = True";
...
public static String  _imgq6_d_click() throws Exception{
 //BA.debugLineNum = 2323;BA.debugLine="Private Sub imgQ6_d_Click";
 //BA.debugLineNum = 2324;BA.debugLine="If lblRojo_Q6_d.visible = True Then";
if (mostCurrent._lblrojo_q6_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
...
mostCurrent._imgpasto_corto.setVisible(anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 2328;BA.debugLine="lblRojo_Q6_d.visible = True";
mostCurrent._lblrojo_q6_d.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2329;BA.debugLine="imgPasto_Corto.Visible = True";
...
public static String  _imgq6_e_click() throws Exception{
 //BA.debugLineNum = 2332;BA.debugLine="Private Sub imgQ6_e_Click";
 //BA.debugLineNum = 2333;BA.debugLine="lblRojo_Q6_a.visible = False";
mostCurrent._lblrojo_q6_a.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2334;BA.debugLine="lblRojo_Q6_b.visible = False";
mostCurrent._lblrojo_q6_b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2335;BA.debugLine="lblRojo_Q6_c.visible = False";
mostCurrent._lblrojo_q6_c.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2336;BA.debugLine="lblRojo_Q6_d.visible = False";
mostCurrent._lblrojo_q6_d.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2337;BA.debugLine="imgPasto_Corto.Visible = False";
mostCurrent._imgpasto_corto.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2338;BA.debugLine="imgPastoLargo.Visible = False";
mostCurrent._imgpastolargo.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2339;BA.debugLine="imgArbustos.Visible = False";
mostCurrent._imgarbustos.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2340;BA.debugLine="imgArboles.Visible = False";
mostCurrent._imgarboles.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2342;BA.debugLine="If lblRojo_Q6_e.visible = True Then";
if (mostCurrent._lblrojo_q6_e.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2343;BA.debugLine="lblRojo_Q6_e.visible = False";
mostCurrent._lblrojo_q6_e.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2345;BA.debugLine="lblRojo_Q6_e.visible = True";
...
public static String  _imgq7_a_click() throws Exception{
 //BA.debugLineNum = 2463;BA.debugLine="Private Sub imgQ7_a_Click";
 //BA.debugLineNum = 2464;BA.debugLine="If lblRojo_Q7_a.visible = True Then";
if (mostCurrent._lblrojo_q7_a.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2465;BA.debugLine="lblRojo_Q7_a.visible = False";
mostCurrent._lblrojo_q7_a.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2466;BA.debugLine="imgBaño.Visible = False";
mostCurrent._imgbaño.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2468;BA.debugLine="lblRojo_Q7_a.visible = True";
mostCurrent._lblrojo_q7_a.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2469;BA.debugLine="imgBaño.Visible = True";
...
public static String  _imgq7_b_click() throws Exception{
 //BA.debugLineNum = 2472;BA.debugLine="Private Sub imgQ7_b_Click";
 //BA.debugLineNum = 2473;BA.debugLine="If lblRojo_Q7_b.visible = True Then";
if (mostCurrent._lblrojo_q7_b.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2474;BA.debugLine="lblRojo_Q7_b.visible = False";
mostCurrent._lblrojo_q7_b.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2475;BA.debugLine="imgPesca.Visible = False";
mostCurrent._imgpesca.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2477;BA.debugLine="lblRojo_Q7_b.visible = True";
mostCurrent._lblrojo_q7_b.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2478;BA.debugLine="imgPesca.Visible = True";
...
public static String  _imgq7_c_click() throws Exception{
 //BA.debugLineNum = 2481;BA.debugLine="Private Sub imgQ7_c_Click";
 //BA.debugLineNum = 2482;BA.debugLine="If lblRojo_Q7_c.visible = True Then";
if (mostCurrent._lblrojo_q7_c.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2483;BA.debugLine="lblRojo_Q7_c.visible = False";
mostCurrent._lblrojo_q7_c.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2484;BA.debugLine="imgKayak.Visible = False";
mostCurrent._imgkayak.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2486;BA.debugLine="lblRojo_Q7_c.visible = True";
mostCurrent._lblrojo_q7_c.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2487;BA.debugLine="imgKayak.Visible = True";
...
public static String  _imgq7_d_click() throws Exception{
 //BA.debugLineNum = 2490;BA.debugLine="Private Sub imgQ7_d_Click";
 //BA.debugLineNum = 2491;BA.debugLine="If lblRojo_Q7_d.visible = True Then";
if (mostCurrent._lblrojo_q7_d.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 2492;BA.debugLine="lblRojo_Q7_d.visible = False";
mostCurrent._lblrojo_q7_d.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 2493;BA.debugLine="imgEmbarcaciones.Visible = False";
mostCurrent._imgembarcaciones.setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 2495;BA.debugLine="lblRojo_Q7_d.visible = True";
mostCurrent._lblrojo_q7_d.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 2496;BA.debugLine="imgEmbarcaciones.Visible = True";
...
public static String  _pnlresultados_click() throws Exception{
 //BA.debugLineNum = 1752;BA.debugLine="Sub pnlResultados_Click";
 //BA.debugLineNum = 1753;BA.debugLine="Return True";
...
public static String  _tabreportehabitatrio_pageselected(int _position) throws Exception{
 //BA.debugLineNum = 658;BA.debugLine="Sub tabReporteHabitatRio_PageSelected (Position As";
 //BA.debugLineNum = 659;BA.debugLine="tabReporteHabitatRio.ScrollTo(currentpregunta,Fal";
...
String _usos = "";
String _hidraulica = "";
 //BA.debugLineNum = 1145;BA.debugLine="Sub TerminarEval";
 //BA.debugLineNum = 1146;BA.debugLine="Log(\"valorind1:\" & valorind1)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623937","valorind1:"+mostCurrent._valorind1,0);
 //BA.debugLineNum = 1147;BA.debugLine="Log(\"valorind2:\" &valorind2)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623938","valorind2:"+mostCurrent._valorind2,0);
 //BA.debugLineNum = 1148;BA.debugLine="Log(\"valorind3:\" &valorind3)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623939","valorind3:"+mostCurrent._valorind3,0);
 //BA.debugLineNum = 1149;BA.debugLine="Log(\"valorind4:\" &valorind4)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623940","valorind4:"+mostCurrent._valorind4,0);
 //BA.debugLineNum = 1150;BA.debugLine="Log(\"valorind5:\" &valorind5)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623941","valorind5:"+mostCurrent._valorind5,0);
 //BA.debugLineNum = 1151;BA.debugLine="Log(\"valorind6:\" &valorind6)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623942","valorind6:"+mostCurrent._valorind6,0);
 //BA.debugLineNum = 1152;BA.debugLine="Log(\"valorind7:\" &valorind7)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623943","valorind7:"+mostCurrent._valorind7,0);
 //BA.debugLineNum = 1153;BA.debugLine="Log(\"valorind8:\" &valorind8)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623944","valorind8:"+mostCurrent._valorind8,0);
 //BA.debugLineNum = 1154;BA.debugLine="Log(\"valorind9:\" &valorind9)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623945","valorind9:"+mostCurrent._valorind9,0);
 //BA.debugLineNum = 1155;BA.debugLine="Log(\"valorind10:\" &valorind10)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623946","valorind10:"+mostCurrent._valorind10,0);
 //BA.debugLineNum = 1156;BA.debugLine="Log(\"valorind11:\" &valorind11)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623947","valorind11:"+mostCurrent._valorind11,0);
 //BA.debugLineNum = 1157;BA.debugLine="Log(\"valorind12:\" &valorind12)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623948","valorind12:"+mostCurrent._valorind12,0);
 //BA.debugLineNum = 1158;BA.debugLine="Log(\"valorind13:\" &valorind13)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623949","valorind13:"+mostCurrent._valorind13,0);
 //BA.debugLineNum = 1159;BA.debugLine="Log(\"valorind14:\" &valorind14)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623950","valorind14:"+mostCurrent._valorind14,0);
 //BA.debugLineNum = 1160;BA.debugLine="Log(\"valorind15:\" &valorind15)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623951","valorind15:"+mostCurrent._valorind15,0);
 //BA.debugLineNum = 1161;BA.debugLine="Log(\"valorind16:\" &valorind16)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623952","valorind16:"+mostCurrent._valorind16,0);
 //BA.debugLineNum = 1162;BA.debugLine="Log(\"checklist:\" &checklist)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623953","checklist:"+mostCurrent._checklist,0);
 //BA.debugLineNum = 1163;BA.debugLine="Log(\"ind_pvm_1:\" &ind_pvm_1)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623954","ind_pvm_1:"+mostCurrent._ind_pvm_1,0);
 //BA.debugLineNum = 1164;BA.debugLine="Log(\"ind_pvm_2:\" &ind_pvm_2)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623955","ind_pvm_2:"+mostCurrent._ind_pvm_2,0);
 //BA.debugLineNum = 1165;BA.debugLine="Log(\"ind_pvm_3:\" &ind_pvm_3)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623956","ind_pvm_3:"+mostCurrent._ind_pvm_3,0);
 //BA.debugLineNum = 1166;BA.debugLine="Log(\"ind_pvm_4:\" &ind_pvm_4)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623957","ind_pvm_4:"+mostCurrent._ind_pvm_4,0);
 //BA.debugLineNum = 1167;BA.debugLine="Log(\"ind_pvm_5:\" &ind_pvm_5)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623958","ind_pvm_5:"+mostCurrent._ind_pvm_5,0);
 //BA.debugLineNum = 1168;BA.debugLine="Log(\"ind_pvm_6:\" &ind_pvm_6)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623959","ind_pvm_6:"+mostCurrent._ind_pvm_6,0);
 //BA.debugLineNum = 1169;BA.debugLine="Log(\"ind_pvm_7:\" &ind_pvm_7)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623960","ind_pvm_7:"+mostCurrent._ind_pvm_7,0);
 //BA.debugLineNum = 1170;BA.debugLine="Log(\"ind_pvm_8:\" &ind_pvm_8)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623961","ind_pvm_8:"+mostCurrent._ind_pvm_8,0);
 //BA.debugLineNum = 1171;BA.debugLine="Log(\"ind_pvm_9:\" &ind_pvm_9)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623962","ind_pvm_9:"+mostCurrent._ind_pvm_9,0);
 //BA.debugLineNum = 1172;BA.debugLine="Log(\"ind_pvm_10:\" &ind_pvm_10)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623963","ind_pvm_10:"+mostCurrent._ind_pvm_10,0);
 //BA.debugLineNum = 1173;BA.debugLine="Log(\"ind_pvm_11:\" &ind_pvm_11)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623964","ind_pvm_11:"+mostCurrent._ind_pvm_11,0);
 //BA.debugLineNum = 1174;BA.debugLine="Log(\"ind_pvm_12:\" &ind_pvm_12)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623965","ind_pvm_12:"+mostCurrent._ind_pvm_12,0);
 //BA.debugLineNum = 1175;BA.debugLine="Log(\"ind_pvm_13:\" &ind_pvm_13)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623966","ind_pvm_13:"+mostCurrent._ind_pvm_13,0);
 //BA.debugLineNum = 1176;BA.debugLine="Log(\"notas:\" & notas)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623967","notas:"+mostCurrent._notas,0);
 //BA.debugLineNum = 1178;BA.debugLine="Log(\"dateandtime:\" &dateandtime)";
anywheresoftware.b4a.keywords.Common.LogImpl("483623969","dateandtime:"+mostCurrent._dateandtime,0);
 //BA.debugLineNum = 1182;BA.debugLine="pnlResultados.Visible = True";
mostCurrent._pnlresultados.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1183;BA.debugLine="pnlResultados.BringToFront";
mostCurrent._pnlresultados.BringToFront();
 //BA.debugLineNum = 1185;BA.debugLine="Dim totpreg As Int = 0";
_totpreg = (int) (0);
 //BA.debugLineNum = 1186;BA.debugLine="valorNS = 0";
_valorns = (int) (0);
 //BA.debugLineNum = 1190;BA.debugLine="CargarDetalle";
_cargardetalle();
 //BA.debugLineNum = 1193;BA.debugLine="If valorind1 = \"NS\" Or valorind1 = \"\" Then ' usos";
if ((mostCurrent._valorind1).equals("NS") || (mostCurrent._valorind1).equals("")) { 
 //BA.debugLineNum = 1194;BA.debugLine="valorind1 = \"0\"";
mostCurrent._valorind1 = "0";
 //BA.debugLineNum = 1195;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1197;BA.debugLine="totpreg = totpreg + 4";
_totpreg = (int) (_totpreg+4);
 };
 //BA.debugLineNum = 1200;BA.debugLine="If valorind2 = \"NS\" Or valorind2 = \"\" Then 'ganad";
if ((mostCurrent._valorind2).equals("NS") || (mostCurrent._valorind2).equals("")) { 
 //BA.debugLineNum = 1201;BA.debugLine="valorind2 = \"0\"";
mostCurrent._valorind2 = "0";
 //BA.debugLineNum = 1202;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1204;BA.debugLine="totpreg = totpreg + 1";
_totpreg = (int) (_totpreg+1);
 };
 //BA.debugLineNum = 1206;BA.debugLine="If valorind3 = \"NS\" Or valorind3 = \"\" Then ' veg";
if ((mostCurrent._valorind3).equals("NS") || (mostCurrent._valorind3).equals("")) { 
 //BA.debugLineNum = 1207;BA.debugLine="valorind3 = \"0\"";
...
_totpreg = (int) (_totpreg+2);
 ...
 //BA.debugLineNum = 1212;BA.debugLine="If valorind4 = \"NS\" Or valorind4 = \"\" Then 'acuat";
if ((mostCurrent._valorind4).equals("NS") || (mostCurrent._valorind4).equals("")) { 
 //BA.debugLineNum = 1213;BA.debugLine="valorind4 = \"0\"";
mostCurrent._valorind4 = "0";
 //BA.debugLineNum = 1214;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1216;BA.debugLine="totpreg = totpreg + 2";
_totpreg = (int) (_totpreg+2);
 };
 //BA.debugLineNum = 1219;BA.debugLine="If valorind5 = \"NS\" Or valorind5 = \"\" Then ' colo";
if ((mostCurrent._valorind5).equals("NS") || (mostCurrent._valorind5).equals("")) { 
 //BA.debugLineNum = 1220;BA.debugLine="valorind5 = \"0\"";
...
_totpreg = (int) (_totpreg+1);
 ...
 //BA.debugLineNum = 1225;BA.debugLine="If valorind6 = \"NS\" Or valorind6 = \"\" Then ' olor";
if ((mostCurrent._valorind6).equals("NS") || (mostCurrent._valorind6).equals("")) { 
 //BA.debugLineNum = 1226;BA.debugLine="valorind6 = \"0\"";
mostCurrent._valorind6 = "0";
 //BA.debugLineNum = 1227;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1229;BA.debugLine="totpreg = totpreg + 1";
_totpreg = (int) (_totpreg+1);
 };
 //BA.debugLineNum = 1231;BA.debugLine="If valorind7 = \"NS\" Or valorind7 = \"\" Then 'basur";
if ((mostCurrent._valorind7).equals("NS") || (mostCurrent._valorind7).equals("")) { 
 //BA.debugLineNum = 1232;BA.debugLine="valorind7 = \"0\"";
mostCurrent._valorind7 = "0";
 //BA.debugLineNum = 1233;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1235;BA.debugLine="totpreg = totpreg + 2";
_totpreg = (int) (_totpreg+2);
 };
 //BA.debugLineNum = 1237;BA.debugLine="If valorind9 = \"NS\" Or valorind9 = \"\" Then ' desb";
if ((mostCurrent._valorind9).equals("NS") || (mostCurrent._valorind9).equals("")) { 
 //BA.debugLineNum = 1238;BA.debugLine="valorind9 = \"0\"";
...
_totpreg = (int) (_totpreg+1);
 ...
 //BA.debugLineNum = 1243;BA.debugLine="If valorind10 = \"NS\" Or valorind10 = \"\" Then ' ca";
if ((mostCurrent._valorind10).equals("NS") || (mostCurrent._valorind10).equals("")) { 
 //BA.debugLineNum = 1244;BA.debugLine="valorind10 = \"0\"";
mostCurrent._valorind10 = "0";
 //BA.debugLineNum = 1245;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1247;BA.debugLine="totpreg = totpreg + 5";
_totpreg = (int) (_totpreg+5);
 };
 //BA.debugLineNum = 1250;BA.debugLine="If ind_pvm_1 = \"NS\" Or ind_pvm_1 = \"\" Then ' espu";
if ((mostCurrent._ind_pvm_1).equals("NS") || (mostCurrent._ind_pvm_1).equals("")) { 
 //BA.debugLineNum = 1251;BA.debugLine="ind_pvm_1 = \"0\"";
mostCurrent._ind_pvm_1 = "0";
 //BA.debugLineNum = 1252;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1254;BA.debugLine="totpreg = totpreg + 2";
_totpreg = (int) (_totpreg+2);
 };
 //BA.debugLineNum = 1256;BA.debugLine="If ind_pvm_2 = \"NS\" Or ind_pvm_2 = \"\" Then 'junco";
if ((mostCurrent._ind_pvm_2).equals("NS") || (mostCurrent._ind_pvm_2).equals("")) { 
 //BA.debugLineNum = 1257;BA.debugLine="ind_pvm_2 = \"0\"";
mostCurrent._ind_pvm_2 = "0";
 //BA.debugLineNum = 1258;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1260;BA.debugLine="totpreg = totpreg + 1";
_totpreg = (int) (_totpreg+1);
 };
 //BA.debugLineNum = 1262;BA.debugLine="If ind_pvm_3 = \"NS\" Or ind_pvm_3 = \"\" Then 'acaci";
if ((mostCurrent._ind_pvm_3).equals("NS") || (mostCurrent._ind_pvm_3).equals("")) { 
 //BA.debugLineNum = 1263;BA.debugLine="ind_pvm_3 = \"0\"";
mostCurrent._ind_pvm_3 = "0";
 //BA.debugLineNum = 1264;BA.debugLine="valorNS = valorNS + 1";
_valorns = (int) (_valorns+1);
 }else {
 //BA.debugLineNum = 1266;BA.debugLine="totpreg = totpreg + 1";
_totpreg = (int) (_totpreg+1);
 };
 //BA.debugLineNum = 1268;BA.debugLine="If ind_pvm_4 = \"NS\" Or ind_pvm_4 = \"\" Then' ligus";
if ((mostCurrent._ind_pvm_4).equals("NS") || (mostCurrent._ind_pvm_4).equals("")) { 
 //BA.debugLineNum = 1269;BA.debugLine="ind_pvm_4 = \"0\"";
...
_totpreg = (int) (_totpreg+1);
 ...
 //BA.debugLineNum = 1276;BA.debugLine="If valorNS > 6  Then";
if (_valorns>6) { 
 //BA.debugLineNum = 1277;BA.debugLine="MsgboxAsync(\"Has seleccionado 'No sé' en muchas";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence("Has seleccionado 'No sé' en muchas opciones en la encuesta, es probable que el estado del hábitat no sea calculado con precisión"),BA.ObjectToCharSequence("Cuidado!"),processBA);
 ...
 //BA.debugLineNum = 1279;BA.debugLine="valorNS = Round((valorNS*100)/13) 'NS";
_valorns = (int) (anywheresoftware.b4a.keywords.Common.Round((_valorns*100)/(double)13));
 //BA.debugLineNum = 1281;BA.debugLine="Dim vegetacion, agua, usos, hidraulica As String";
_vegetacion = "";
_agua = "";
_usos = "";
_hidraulica = "";
 //BA.debugLineNum = 1282;BA.debugLine="vegetacion = valorind3*2 + valorind4*2 + ind_pvm_";
_vegetacion = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind3))*2+(double)(Double.parseDouble(mostCurrent._valorind4))*2+(double)(Double.parseDouble(mostCurrent._ind_pvm_2))+(double)(Double.parseDouble(mostCurrent._ind_pvm_3))+(double)(Double.parseDouble(mostCurrent._ind_pvm_4)));
 //BA.debugLineNum = 1283;BA.debugLine="agua = valorind5 + valorind6 + valorind7*2 + ind_";
_agua = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind5))+(double)(Double.parseDouble(mostCurrent._valorind6))+(double)(Double.parseDouble(mostCurrent._valorind7))*2+(double)(Double.parseDouble(mostCurrent._ind_pvm_1))*2);
 //BA.debugLineNum = 1284;BA.debugLine="usos = valorind1*4+ valorind2";
_usos = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind1))*4+(double)(Double.parseDouble(mostCurrent._valorind2)));
 //BA.debugLineNum = 1285;BA.debugLine="hidraulica = valorind9 + valorind10*5";
_hidraulica = BA.NumberToString((double)(Double.parseDouble(mostCurrent._valorind9))+(double)(Double.parseDouble(mostCurrent._valorind10))*5);
 //BA.debugLineNum = 1286;BA.debugLine="valorcalidad = ((vegetacion + agua + usos + hidra";
...
if (_valorcalidad<20) { 
 //BA.debugLineNum = 1308;BA.debugLine="lblEstado.Text = \"Very bad\"";
mostCurrent._lblestado.setText(BA.ObjectToCharSequence("Very bad"));
 }else if(_valorcalidad>=20 && _valorcalidad<40) { 
 //BA.debugLineNum = 1310;BA.debugLine="lblEstado.Text = \"Bad\"";
mostCurrent._lblestado.setText(BA.ObjectToCharSequence("Bad"));
 }else if(_valorcalidad>=40 && _valorcalidad<60) { 
 //BA.debugLineNum = 1312;BA.debugLine="lblEstado.Text = \"Regular\"";
mostCurrent._lblestado.setText(BA.ObjectToCharSequence("Regular"));
 }else if(_valorcalidad>=60 && _valorcalidad<80) { 
 //BA.debugLineNum = 1314;BA.debugLine="lblEstado.Text = \"Good\"";
mostCurrent._lblestado.setText(BA.ObjectToCharSequence("Good"));
 }else if(_valorcalidad>=80) { 
 //BA.debugLineNum = 1316;BA.debugLine="lblEstado.Text = \"Very good!\"";
mostCurrent._lblestado.setText(BA.ObjectToCharSequence("Very good!"));
 };
 };
 //BA.debugLineNum = 1320;BA.debugLine="Log(\"valorNS:\" &valorNS)";
anywheresoftware.b4a.keywords.Common.LogImpl("483624111","valorNS:"+BA.NumberToString(_valorns),0);
 //BA.debugLineNum = 1321;BA.debugLine="Log(\"valorcalidad:\" &valorcalidad)";
anywheresoftware.b4a.keywords.Common.LogImpl("483624112","valorcalidad:"+BA.NumberToString(_valorcalidad),0);
 //BA.debugLineNum = 1324;BA.debugLine="Gauge1.SetRanges(Array(Gauge1.CreateRange(0, 20,";
mostCurrent._gauge1._setranges /*String*/ (anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._gauge1._createrange /*appear.pnud.preservamos.gauge._gaugerange*/ ((float) (0),(float) (20),mostCurrent._xui.Color_DarkGray)),(Object)(mostCurrent._gauge1._createrange /*appear.pnud.preservamos.gauge._gaugerange*/ ((float) (20),(float) (40),mostCurrent._xui.Color_Red)),(Object)(mostCurrent._gauge1._createrange /*appear.pnud.preservamos.gauge._gaugerange*/ ((float) (40),(float) (60),mostCurrent._xui.Color_Yellow)),(Object)(mostCurrent._gauge1._createrange /*appear.pnud.preservamos.gauge._gaugerange*/ ((float) (60),(float) (80),mostCurrent._xui.Color_Green)),(Object)(mostCurrent._gauge1._createrange /*appear.pnud.preservamos.gauge._gaugerange*/ ((float) (80),(float) (100),mostCurrent._xui.Color_Blue))}));
 //BA.debugLineNum = 1325;BA.debugLine="Gauge1.CurrentValue = 0";
mostCurrent._gauge1._setcurrentvalue /*float*/ ((float) (0));
 //BA.debugLineNum = 1326;BA.debugLine="Gauge1.CurrentValue = valorcalidad";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bbmp = null;
 //BA.debugLineNum = 1769;BA.debugLine="Private Sub zoomQ6_2_Click";
 //BA.debugLineNum = 1771;BA.debugLine="currentscreen = \"foto\"";
mostCurrent._currentscreen = "foto";
 //BA.debugLineNum = 1773;BA.debugLine="fondogris.Initialize(\"fondogris\")";
mostCurrent._fondogris.Initialize(mostCurrent.activityBA,"fondogris");
 //BA.debugLineNum = 1774;BA.debugLine="fondogris.Color = Colors.ARGB(150,0,0,0)";
mostCurrent._fondogris.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 1775;BA.debugLine="Activity.AddView(fondogris, 0, 0, 100%x, 100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._fondogris.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 1778;BA.debugLine="img1 = imgQ6_2.Bitmap";
mostCurrent._img1 = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(mostCurrent._imgq6_2.getBitmap()));
 //BA.debugLineNum = 1779;BA.debugLine="mag1.Initialize(\"mag1\")";
mostCurrent._mag1.Initialize(mostCurrent.activityBA,"mag1");
 //BA.debugLineNum = 1781;BA.debugLine="Activity.AddView(mag1, 0, Activity.Height / 6, Ac";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._mag1.getObject()),(int) (0),(int) (mostCurrent._activity.getHeight()/(double)6),mostCurrent._activity.getWidth(),(int) (mostCurrent._activity.getHeight()/(double)1.5));
 //BA.debugLineNum = 1782;BA.debugLine="Dim bbmp As Bitmap";
_bbmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 1783;BA.debugLine="bbmp.Initialize3(img1)";
_bbmp.Initialize3((android.graphics.Bitmap)(mostCurrent._img1.getObject()));
 //BA.debugLineNum = 1784;BA.debugLine="mag1.MagnifizeBitmap = bbmp";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bbmp = null;
 //BA.debugLineNum = 1787;BA.debugLine="Private Sub zoomQ6_3_Click";
 //BA.debugLineNum = 1789;BA.debugLine="currentscreen = \"foto\"";
mostCurrent._currentscreen = "foto";
 //BA.debugLineNum = 1791;BA.debugLine="fondogris.Initialize(\"fondogris\")";
mostCurrent._fondogris.Initialize(mostCurrent.activityBA,"fondogris");
 //BA.debugLineNum = 1792;BA.debugLine="fondogris.Color = Colors.ARGB(150,0,0,0)";
mostCurrent._fondogris.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 1793;BA.debugLine="Activity.AddView(fondogris, 0, 0, 100%x, 100%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._fondogris.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 1796;BA.debugLine="img1 = imgQ6_3.Bitmap";
mostCurrent._img1 = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(mostCurrent._imgq6_3.getBitmap()));
 //BA.debugLineNum = 1797;BA.debugLine="mag1.Initialize(\"mag1\")";
mostCurrent._mag1.Initialize(mostCurrent.activityBA,"mag1");
 //BA.debugLineNum = 1799;BA.debugLine="Activity.AddView(mag1, 0, Activity.Height / 6, Ac";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._mag1.getObject()),(int) (0),(int) (mostCurrent._activity.getHeight()/(double)6),mostCurrent._activity.getWidth(),(int) (mostCurrent._activity.getHeight()/(double)1.5));
 //BA.debugLineNum = 1800;BA.debugLine="Dim bbmp As Bitmap";
_bbmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 1801;BA.debugLine="bbmp.Initialize3(img1)";
_bbmp.Initialize3((android.graphics.Bitmap)(mostCurrent._img1.getObject()));
 //BA.debugLineNum = 1802;BA.debugLine="mag1.MagnifizeBitmap = bbmp";
mostCurrent._mag1.setMagnifizeBitmap((android.graphics.Bitmap)(_bbmp.getObject()));

...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "appear.pnud.preservamos.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", appear.pnud.preservamos.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _huebar = null;
public appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _colorpicker = null;
public appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _alphabar = null;
public int _borderscolor = 0;
public appear.pnud.preservamos.b4xdialog _xdialog = null;
...
int _r = 0;
int _w = 0;
appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_cpp = (appear.pnud.preservamos.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_huebar = new appear.pnud.preservamos.b4xcolortemplate._colorpickerpart();
_colorpicker = new appear.pnud.preservamos.b4xcolortemplate._colorpickerpart();
_alphabar = new appear.pnud.preservamos.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 12;BA.debugLine="Private BordersColor As Int";
_borderscolor = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new appear.pnud.preservamos.b4xdialog();
...
public appear.pnud.preservamos.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new appear.pnud.preservamos.b4xcolortemplate._colorpickerpart();
...
public String  _drawcheckers(appear.pnud.preservamos.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public ResumableSub_Show(appear.pnud.preservamos.b4xcolortemplate parent,appear.pnud.preservamos.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
appear.pnud.preservamos.b4xcolortemplate parent;

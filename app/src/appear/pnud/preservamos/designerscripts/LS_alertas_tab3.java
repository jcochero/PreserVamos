...
//BA.debugLineNum = 7;BA.debugLine="imgFoto4.left = imgFoto3.Right  + 10dip"[Alertas_Tab3/General script]
views.get("imgfoto4").vw.setLeft((int)((views.get("imgfoto3").vw.getLeft() + views.get("imgfoto3").vw.getWidth())+(10d * scale)));
//BA.debugLineNum = 8;BA.debugLine="ProgressBar1.SetLeftAndRight(imgFoto1.Left, imgFoto1.Right)"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 9;BA.debugLine="ProgressBar2.SetLeftAndRight(imgFoto2.Left, imgFoto2.Right)"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 10;BA.debugLine="ProgressBar3.SetLeftAndRight(imgFoto3.Left, imgFoto3.Right)"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 11;BA.debugLine="ProgressBar4.SetLeftAndRight(imgFoto3.Left, imgFoto4.Right)"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 12;BA.debugLine="borderFotos1.HorizontalCenter = imgFoto1.HorizontalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 13;BA.debugLine="borderFotos1.VerticalCenter = imgFoto1.VerticalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 14;BA.debugLine="borderFotos2.HorizontalCenter = imgFoto2.HorizontalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 15;BA.debugLine="borderFotos2.VerticalCenter = imgFoto2.VerticalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 16;BA.debugLine="borderFotos3.HorizontalCenter = imgFoto3.HorizontalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 17;BA.debugLine="borderFotos3.VerticalCenter = imgFoto3.VerticalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 18;BA.debugLine="borderFotos4.HorizontalCenter = imgFoto4.HorizontalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 19;BA.debugLine="borderFotos4.VerticalCenter = imgFoto4.VerticalCenter"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 20;BA.debugLine="lblTelefonoTitle.Top = borderFotos1.Bottom + 40dip"[Alertas_Tab3/General script]
views.get("lbltelefonotitle").vw.setTop((int)((views.get("borderfotos1").vw.getTop() + views.get("borderfotos1").vw.getHeight())+(40d * scale)));
//BA.debugLineNum = 21;BA.debugLine="txtTelefono.Top = lblTelefonoTitle.Bottom + 5dip"[Alertas_Tab3/General script]
...
//BA.debugLineNum = 23;BA.debugLine="txtNotas.top = lblNotasTitle.Bottom + 5dip"[Alertas_Tab3/General script]

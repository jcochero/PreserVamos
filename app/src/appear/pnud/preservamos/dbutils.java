...
anywheresoftware.b4a.keywords.Common.LogImpl("437683214","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438666245","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438666255","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("437748738","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438338567","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438273032","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438273047","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("437945352","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("437945354","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("437879814","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("437814276","Same Map found twice in list. Each item in the list should include a different map object.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("437814300","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("437814305",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("438600706","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438600710","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("438600731","UpdateRecord: "+_sb.ToString(),0);

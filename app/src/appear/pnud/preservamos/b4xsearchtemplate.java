...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "appear.pnud.preservamos.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", appear.pnud.preservamos.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public appear.pnud.preservamos.b4xfloattextfield _searchfield = null;
...
_searchfield = new appear.pnud.preservamos.b4xfloattextfield();
...
__c.LogImpl("916318495","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(appear.pnud.preservamos.b4xsearchtemplate parent,appear.pnud.preservamos.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
appear.pnud.preservamos.b4xsearchtemplate parent;

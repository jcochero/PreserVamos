...
public class frmpoliticadatos extends Activity implements B4AActivity{
	...
	private void afterFirstLayout() {
        ...
        BA.LogInfo("** Activity (frmpoliticadatos) Create " + (isFirst ? "(first time)" : "") + " **");
...
mostCurrent._scrpoliticadatos.getPanel().AddView((android.view.View)(mostCurrent._pnlpoliticadatos.getObject()),(int) (0),(int) (0),mostCurrent._scrpoliticadatos.getPanel().getWidth(),(int) (mostCurrent._lblterceras.getHeight()+mostCurrent._lblterceras.getTop()));
 //BA.debugLineNum = 34;BA.debugLine="scrPoliticaDatos.Panel.Height = lblTerceras.Heigh";
mostCurrent._scrpoliticadatos.getPanel().setHeight((int) (mostCurrent._lblterceras.getHeight()+mostCurrent._lblterceras.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));

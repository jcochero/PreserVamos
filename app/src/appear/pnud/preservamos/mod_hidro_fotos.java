...
public class mod_hidro_fotos extends Activity implements B4AActivity{
	public static mod_hidro_fotos mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "appear.pnud.preservamos", "appear.pnud.preservamos.mod_hidro_fotos");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mod_hidro_fotos).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "appear.pnud.preservamos", "appear.pnud.preservamos.mod_hidro_fotos");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "appear.pnud.preservamos.mod_hidro_fotos", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mod_hidro_fotos) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mod_hidro_fotos) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (mod_hidro_fotos) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (mod_hidro_fotos) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            mod_hidro_fotos mc = mostCurrent;
...
anywheresoftware.b4a.keywords.Common.LogImpl("457671687",mostCurrent._cam._getsupportedhardwarelevel /*String*/ (),0);
...
public static String  _btnadjuntarfoto_click() throws Exception{
 //BA.debugLineNum = 296;BA.debugLine="Sub btnAdjuntarFoto_Click";
 //BA.debugLineNum = 298;BA.debugLine="cam.Stop";
mostCurrent._cam._stop /*String*/ ();
 //BA.debugLineNum = 300;BA.debugLine="CC.Initialize(\"CC\")";
_cc.Initialize("CC");
 //BA.debugLineNum = 301;BA.debugLine="CC.Show(\"image/\", \"Elija la foto\")";
_cc.Show(processBA,"image/","Elija la foto");
 //BA.debugLineNum = 302;BA.debugLine="End Sub";
return "";
}
public static String  _btncamera_click() throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Sub btnCamera_Click";
 //BA.debugLineNum = 158;BA.debugLine="frontCamera = Not(frontCamera)";
_frontcamera = anywheresoftware.b4a.keywords.Common.Not(_frontcamera);
 //BA.debugLineNum = 159;BA.debugLine="OpenCamera(frontCamera)";
_opencamera(_frontcamera);
 //BA.debugLineNum = 160;BA.debugLine="End Sub";
return "";
}
public static String  _btncontinuar_click() throws Exception{
 //BA.debugLineNum = 365;BA.debugLine="Sub btnContinuar_Click";
 //BA.debugLineNum = 366;BA.debugLine="cam.Stop";
mostCurrent._cam._stop /*String*/ ();
 //BA.debugLineNum = 367;BA.debugLine="Activity.RemoveAllViews";
...
public static String  _btnrecord_click() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub btnRecord_Click";
 //BA.debugLineNum = 170;BA.debugLine="TakePicture";
_takepicture();
...
anywheresoftware.b4a.objects.collections.Map _map1 = null;
 //BA.debugLineNum = 304;BA.debugLine="Sub CC_Result (Success As Boolean, Dir As String,";
 //BA.debugLineNum = 305;BA.debugLine="If Success = True Then";
if (_success==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 308;BA.debugLine="Dim Map1 As Map";
_map1 = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 309;BA.debugLine="Map1.Initialize";
_map1.Initialize();
 //BA.debugLineNum = 310;BA.debugLine="Map1.Put(\"Id\", Form_Reporte.currentproject)";
_map1.Put((Object)("Id"),(Object)(mostCurrent._form_reporte._currentproject /*String*/ ));
 //BA.debugLineNum = 311;BA.debugLine="DateTime.DateFormat = \"dd-MM-yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("dd-MM-yyyy");
 //BA.debugLineNum = 312;BA.debugLine="File.Copy(Dir, FileName, Starter.savedir, fotoNo";
anywheresoftware.b4a.keywords.Common.File.Copy(_dir,_filename,mostCurrent._starter._savedir /*String*/ ,mostCurrent._fotonombredestino+".jpg");
 //BA.debugLineNum = 313;BA.debugLine="mod_Hidro.foto1_path = fotoNombreDestino";
mostCurrent._mod_hidro._foto1_path /*String*/  = mostCurrent._fotonombredestino;
 //BA.debugLineNum = 315;BA.debugLine="DesignaFoto";
_designafoto();
 };
...
public ResumableSub_closeAppMsgBox(appear.pnud.preservamos.mod_hidro_fotos parent) {
this.parent = parent;
}
appear.pnud.preservamos.mod_hidro_fotos parent;
int _result = 0;
...
String _rndstr = "";
 //BA.debugLineNum = 329;BA.debugLine="Sub DesignaFoto";
 //BA.debugLineNum = 331;BA.debugLine="DateTime.DateFormat = \"dd-MM-yyyy\"";
anywheresoftware.b4a.keywords.Common.DateTime.setDateFormat("dd-MM-yyyy");
 //BA.debugLineNum = 332;BA.debugLine="ProgressDialogShow(\"Preparando cámara...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("Preparando cámara..."));
 //BA.debugLineNum = 335;BA.debugLine="Log(\"Designando foto\")";
anywheresoftware.b4a.keywords.Common.LogImpl("458982406","Designando foto",0);
 //BA.debugLineNum = 337;BA.debugLine="Dim RndStr As String";
_rndstr = "";
 //BA.debugLineNum = 338;BA.debugLine="RndStr = utilidades.RandomString(6)";
_rndstr = mostCurrent._utilidades._randomstring /*String*/ (mostCurrent.activityBA,(int) (6));
 //BA.debugLineNum = 340;BA.debugLine="If mod_Hidro.foto1_path = \"\" Then";
if ((mostCurrent._mod_hidro._foto1_path /*String*/ ).equals("")) { 
 //BA.debugLineNum = 341;BA.debugLine="fotoNombreDestino = Main.strUserEmail.Replace(\".";
mostCurrent._fotonombredestino = mostCurrent._main._struseremail /*String*/ .replace(".","_");
 //BA.debugLineNum = 342;BA.debugLine="fotoNombreDestino = fotoNombreDestino.Replace(\"@";
...
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 347;BA.debugLine="CallSubDelayed(mod_Hidro, \"ActualizarFotos\")";
anywheresoftware.b4a.keywords.Common.CallSubDelayed(processBA,(Object)(mostCurrent._mod_hidro.getObject()),"ActualizarFotos");
...
public static String  _handleerror(anywheresoftware.b4a.objects.B4AException _error) throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub HandleError (Error As Exception)";
 //BA.debugLineNum = 164;BA.debugLine="Log(\"Error: \" & Error)";
anywheresoftware.b4a.keywords.Common.LogImpl("458261505","Error: "+BA.ObjectToString(_error),0);
 //BA.debugLineNum = 165;BA.debugLine="ToastMessageShow(Error, True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_error.getObject()),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 166;BA.debugLine="OpenCamera(frontCamera)";
_opencamera(_frontcamera);
 //BA.debugLineNum = 167;BA.debugLine="End Sub";
return "";
}
public static String  _imgmenu_click() throws Exception{
 //BA.debugLineNum = 275;BA.debugLine="Sub imgMenu_Click";
...
public static String  _mnuadjuntar_click() throws Exception{
 //BA.debugLineNum = 278;BA.debugLine="Sub mnuAdjuntar_Click";
 //BA.debugLineNum = 280;BA.debugLine="cam.Stop";
mostCurrent._cam._stop /*String*/ ();
 //BA.debugLineNum = 281;BA.debugLine="DesignaFoto";
_designafoto();
 //BA.debugLineNum = 282;BA.debugLine="CC.Initialize(\"CC\")";
_cc.Initialize("CC");
 //BA.debugLineNum = 283;BA.debugLine="CC.Show(\"image/\", \"Elija la foto\")";
_cc.Show(processBA,"image/","Elija la foto");
...
public ResumableSub_OpenCamera(appear.pnud.preservamos.mod_hidro_fotos parent,boolean _front) {
this.parent = parent;
this._front = _front;
}
appear.pnud.preservamos.mod_hidro_fotos parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 110;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_CAMERA)";
parent.mostCurrent._rp.CheckAndRequest(processBA,parent.mostCurrent._rp.PERMISSION_CAMERA);
 //BA.debugLineNum = 111;BA.debugLine="Wait For Activity_PermissionResult (Permission As";
...
;
 //BA.debugLineNum = 112;BA.debugLine="If Result = False Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 113;BA.debugLine="ToastMessageShow(\"No permission!\", True)";
...
this.state = 5;
;
 //BA.debugLineNum = 117;BA.debugLine="SetState(False, False, VideoMode)";
_setstate(anywheresoftware.b4a.keywords.Common.False,anywheresoftware.b4a.keywords.Common.False,parent._videomode);
 //BA.debugLineNum = 118;BA.debugLine="Wait For (cam.OpenCamera(front)) Complete (TaskIn";
...
;
 //BA.debugLineNum = 119;BA.debugLine="If TaskIndex > 0 Then";
if (true) break;
...
//C
this.state = 8;
 //BA.debugLineNum = 120;BA.debugLine="MyTaskIndex = TaskIndex 'hold this index. It wil";
parent._mytaskindex = _taskindex;
 //BA.debugLineNum = 121;BA.debugLine="Wait For(PrepareSurface) Complete (Success As Bo";
...
this.state = 9;
;
 //BA.debugLineNum = 123;BA.debugLine="Log(\"Start success: \" & Success)";
anywheresoftware.b4a.keywords.Common.LogImpl("457999374","Start success: "+BA.ObjectToString(_success),0);
 //BA.debugLineNum = 124;BA.debugLine="SetState(Success, False, VideoMode)";
_setstate(_success,anywheresoftware.b4a.keywords.Common.False,parent._videomode);
 //BA.debugLineNum = 125;BA.debugLine="If Success = False Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 126;BA.debugLine="ToastMessageShow(\"Failed to open camera\", True)";
...
public static String  _pnlbackground_click() throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Sub pnlBackground_Click";
 //BA.debugLineNum = 202;BA.debugLine="pnlBackground.Visible = False";
...
public ResumableSub_PrepareSurface(appear.pnud.preservamos.mod_hidro_fotos parent) {
this.parent = parent;
}
appear.pnud.preservamos.mod_hidro_fotos parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 131;BA.debugLine="SetState(False, busystate, VideoMode)";
_setstate(anywheresoftware.b4a.keywords.Common.False,parent._busystate,parent._videomode);
 //BA.debugLineNum = 133;BA.debugLine="If VideoMode Then";
if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 134;BA.debugLine="cam.PreviewSize.Initialize(640, 480)";
parent.mostCurrent._cam._previewsize /*anywheresoftware.b4a.objects.Camera2.CameraSizeWrapper*/ .Initialize((int) (640),(int) (480));
 //BA.debugLineNum = 135;BA.debugLine="ResizePreviewPanelBasedPreviewSize";
_resizepreviewpanelbasedpreviewsize();
 //BA.debugLineNum = 137;BA.debugLine="Wait For (cam.PrepareSurfaceForVideo(MyTaskIndex";
...
//C
this.state = 6;
 //BA.debugLineNum = 139;BA.debugLine="cam.PreviewSize.Initialize(1920, 1080)";
parent.mostCurrent._cam._previewsize /*anywheresoftware.b4a.objects.Camera2.CameraSizeWrapper*/ .Initialize((int) (1920),(int) (1080));
 //BA.debugLineNum = 140;BA.debugLine="ResizePreviewPanelBasedPreviewSize";
_resizepreviewpanelbasedpreviewsize();
 //BA.debugLineNum = 141;BA.debugLine="Wait For (cam.PrepareSurface(MyTaskIndex)) Compl";
...
;
 if (true) break;
;
 //BA.debugLineNum = 144;BA.debugLine="If Success Then cam.StartPreview(MyTaskIndex, Vid";
...
this.state = -1;
;
 //BA.debugLineNum = 145;BA.debugLine="SetState(Success, busystate, VideoMode)";
_setstate(_success,parent._busystate,parent._videomode);
 //BA.debugLineNum = 146;BA.debugLine="Return Success";
if (true) {
...
int _w = 0;
int _h = 0;
 //BA.debugLineNum = 149;BA.debugLine="Private Sub ResizePreviewPanelBasedPreviewSize";
 //BA.debugLineNum = 150;BA.debugLine="Dim pw = cam.PreviewSize.Height, ph = cam.Preview";
...
_ph = mostCurrent._cam._previewsize /*anywheresoftware.b4a.objects.Camera2.CameraSizeWrapper*/ .getWidth();
 //BA.debugLineNum = 151;BA.debugLine="Dim r As Float = Max(Activity.Width / pw, Activit";
_r = (float) (anywheresoftware.b4a.keywords.Common.Max(mostCurrent._activity.getWidth()/(double)_pw,mostCurrent._activity.getHeight()/(double)_ph));
 //BA.debugLineNum = 152;BA.debugLine="Dim w As Int = pw * r";
_w = (int) (_pw*_r);
 //BA.debugLineNum = 153;BA.debugLine="Dim h As Int = ph * r";
_h = (int) (_ph*_r);
 //BA.debugLineNum = 154;BA.debugLine="pnlCamera.SetLayoutAnimated(0, Round(Activity.Wid";
...
int _orientation = 0;
 //BA.debugLineNum = 243;BA.debugLine="Private Sub RotateJpegIfNeeded (bmp As B4XBitmap,";
 //BA.debugLineNum = 244;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 245;BA.debugLine="If p.SdkVersion >= 24 Then";
if (_p.getSdkVersion()>=24) { 
 //BA.debugLineNum = 246;BA.debugLine="Dim ExifInterface As JavaObject";
_exifinterface = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 247;BA.debugLine="Dim in As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 248;BA.debugLine="in.InitializeFromBytesArray(Data, 0, Data.Length";
_in.InitializeFromBytesArray(_data,(int) (0),_data.length);
 //BA.debugLineNum = 249;BA.debugLine="ExifInterface.InitializeNewInstance(\"android.med";
_exifinterface.InitializeNewInstance("android.media.ExifInterface",new Object[]{(Object)(_in.getObject())});
 //BA.debugLineNum = 250;BA.debugLine="Dim orientation As Int = ExifInterface.RunMethod";
_orientation = (int)(BA.ObjectToNumber(_exifinterface.RunMethod("getAttribute",new Object[]{(Object)("Orientation")})));
 //BA.debugLineNum = 251;BA.debugLine="Select orientation";
switch (_orientation) {
case 3: {
 //BA.debugLineNum = 253;BA.debugLine="bmp = bmp.Rotate(180)";
_bmp = _bmp.Rotate((int) (180));
 break; }
case 6: {
 //BA.debugLineNum = 255;BA.debugLine="bmp = bmp.Rotate(90)";
_bmp = _bmp.Rotate((int) (90));
 break; }
case 8: {
 //BA.debugLineNum = 257;BA.debugLine="bmp = bmp.Rotate(270)";
_bmp = _bmp.Rotate((int) (270));
 break; }
}
;
 //BA.debugLineNum = 259;BA.debugLine="in.Close";
_in.Close();
 };
 //BA.debugLineNum = 261;BA.debugLine="Return bmp";
if (true) return _bmp;
...
public ResumableSub_TakePicture(appear.pnud.preservamos.mod_hidro_fotos parent) {
this.parent = parent;
}
appear.pnud.preservamos.mod_hidro_fotos parent;
byte[] _data = null;
...
this.state = 6;
this.catchState = 5;
 //BA.debugLineNum = 175;BA.debugLine="SetState(openstate, True, VideoMode)";
_setstate(parent._openstate,anywheresoftware.b4a.keywords.Common.True,parent._videomode);
 //BA.debugLineNum = 176;BA.debugLine="Wait For(cam.FocusAndTakePicture(MyTaskIndex)) C";
...
_data = (byte[]) result[0];
;
 //BA.debugLineNum = 177;BA.debugLine="SetState(openstate, False, VideoMode)";
_setstate(parent._openstate,anywheresoftware.b4a.keywords.Common.False,parent._videomode);
 //BA.debugLineNum = 180;BA.debugLine="cam.DataToFile(Data, Starter.savedir, fotoNombre";
parent.mostCurrent._cam._datatofile /*String*/ (_data,parent.mostCurrent._starter._savedir /*String*/ ,parent.mostCurrent._fotonombredestino+".jpg");
 //BA.debugLineNum = 182;BA.debugLine="Dim bmp As Bitmap = cam.DataToBitmap(Data)";
...
_bmp = parent.mostCurrent._cam._datatobitmap /*anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper*/ (_data);
 //BA.debugLineNum = 183;BA.debugLine="Log(\"Picture taken: \" & bmp) 'ignore";
anywheresoftware.b4a.keywords.Common.LogImpl("458392586","Picture taken: "+BA.ObjectToString(_bmp),0);
 //BA.debugLineNum = 184;BA.debugLine="pnlBackground.SetVisibleAnimated(100, True)";
parent.mostCurrent._pnlbackground.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 185;BA.debugLine="B4XImageView1.Bitmap = RotateJpegIfNeeded(bmp, D";
parent.mostCurrent._b4ximageview1._setbitmap /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper*/ (_rotatejpegifneeded((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(_bmp.getObject())),_data));
 //BA.debugLineNum = 187;BA.debugLine="pnlBackground.SetVisibleAnimated(500, False)";
parent.mostCurrent._pnlbackground.SetVisibleAnimated((int) (500),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 190;BA.debugLine="mod_Hidro.foto1_path = fotoNombreDestino";
parent.mostCurrent._mod_hidro._foto1_path /*String*/  = parent.mostCurrent._fotonombredestino;
 //BA.debugLineNum = 192;BA.debugLine="DesignaFoto";
_designafoto();
 if (true) break;
...
this.state = 6;
this.catchState = 0;
 //BA.debugLineNum = 194;BA.debugLine="HandleError(LastException)";

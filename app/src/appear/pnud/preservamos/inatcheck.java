...
anywheresoftware.b4a.keywords.Common.LogImpl("526083329","GetiNatTaxa messages: "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("526083371",_job._errormessage /*String*/ ,0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("525952272",BA.NumberToString(parent.mostCurrent._mylocation.getLatitude()),0);
 //BA.debugLineNum = 195;BA.debugLine="Log(myLocation.Longitude)";
anywheresoftware.b4a.keywords.Common.LogImpl("525952273",BA.NumberToString(parent.mostCurrent._mylocation.getLongitude()),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("526017835","radioValue:"+BA.NumberToString(_radiovalue),0);
